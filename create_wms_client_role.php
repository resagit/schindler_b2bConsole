...
//                        alert(warehouseOptions);
            ...
            function get_ui_tabs()
            {
                ...
                $.post("getUiTabsForProject_wms.php", "", function (hd) {
                    choicess = [];
                    ...
                    if ($.trim(hd) == 'N') {
                        ...
                        for (var i = 0; i < obj.LIST.length; i++) {
                            ...
                            $('#ui_table').append("<tr id='" + i + "'><td><input type='checkbox' style='margin:20px' class='check_role' name='check_role' id='check_role'  value='" + dataw[i][0] + "'></td><td>" + dataw[i][1] + "</td><td><input type='text' class='form-control pos' id='pos'  name='pos' style='width: 30%' ></td></tr>");
                        ...
                        $(".check_role").click(function () {
                            ...
                            if ($(this).prop("checked") == true) {
                                ...
                                while (this_element < total_rows) {
                                    ...
                                    $("#ui_table #"+this_element).find("input[type=text]").attr("disabled", "disabled");
                                    $("#ui_table #"+this_element).find("input[type=text]").val("");
                                    $("#ui_table #"+this_element).find("input[type=checkbox]").attr('checked', false);
...
//alert(vals+"vals nd cont "+count);
                ...
                if(status=='true')
                {
                    ...
                    data_pass+=d;
                    //  alert(data_pass)
                    $.get("new_role_wms.php",data_pass, function (hd) {
