...
//
            ...
            function set_warehouse_shipper(arr)
            {
              //  alert(arr)
                ...
                for (var i = 0; i < obj.WAREHOUSE.length; i++) {
                    ...
                    dataw[i][2] = obj.WAREHOUSE[i].islocationAvailable;
                    /*   datak[i][2] = obj.LIST[i].tinNo;
                     datak[i][3] = obj.LIST[i].cinNo;*/
                    //data[i][1]=obj.LIST[i].name;
                    //data[i][7]=obj.DETAIL[i].requestTimestamp;

                    warehouse = warehouse + "<option  id=" + dataw[i][2] + " value = " + dataw[i][0] + ">" + dataw[i][1] + "</option>";
            ...
            function get_bill_type(id) {
               ...
               // alert(location + "location")
                var main = {"company_id": $("#ids_value").val(), "warehouseid": $("#warehouse_id").val()}

                $('#tbd1').html("");
                if (location == "1") {
                    $.get("getDataForLocationWiseManualStockUpdate.php", main, function (a1) {
                      //  alert(a1)
                        var obj1 = JSON.parse(a1);
                        var data1 = new Array();

                        for (var j = 0; j < obj1.DATA.length; j++) {
                            data1[j] = new Array();
                            data1[j][0] = obj1.DATA[j].timeStamp;
                            data1[j][1] = obj1.DATA[j].item_code;
                            data1[j][2] = obj1.DATA[j].material_name;
                            data1[j][3] = obj1.DATA[j].stockType;
                            data1[j][4] = obj1.DATA[j].physicalQt;
                            data1[j][5] = obj1.DATA[j].systemQt;
                            data1[j][6] = obj1.DATA[j].client_material_itemID;
                            data1[j][7] = obj1.DATA[j].unitOfMeasurement;
                            data1[j][8] = obj1.DATA[j].stockAdjustment;
                            data1[j][9] = obj1.DATA[j].locationID;
                            data1[j][10] = obj1.DATA[j].physicalID;
                            if (data1[j][4] == data1[j][5] || data1[j][8]=="1") {

                                $('#tbd1').append("<tr style='cursor: pointer' lang='"+data1[j][9]+"'  id='" + data1[j][6] + "' title='" + data1[j][3] + "'><td class='data'>" + data1[j][0] + "</td><td class='item_code'>" + data1[j][1] + "</td><td class='material_name'>" + data1[j][2] + "</td><td class='sto_tpe'>" + data1[j][3] + "</td><td class='phy_qt'>" + data1[j][4] + "</td><td class='sys_qt'>" + data1[j][5] + "</td><td><button id='" + data1[j][1] + "' style='display:none' class='btn btn-default'>Update Stock</button></tr>");

                            } else {

                                $('#tbd1').append("<tr style='cursor: pointer'  ><td class='data'>" + data1[j][0] + "</td><td class='item_code'>" + data1[j][1] + "</td><td class='material_name'>" + data1[j][2] + "</td><td class='sto_tpe'>" + data1[j][3] + "</td><td class='phy_qt'>" + data1[j][4] + "</td><td class='sys_qt'>" + data1[j][5] + "</td><td><button  lang='"+data1[j][9]+"' id='" + data1[j][6] + "' title='" + data1[j][3] + "' onclick='update_stock_location(this.id,this.title,this.lang)'  class='btn btn-default'>Update Stock</button></tr>");
                ...
                $.get("getDataForManualStock.php", main, function (aa) {
                   // alert(aa)
                    ...
                    for (var i = 0; i < obj.DATA.length; i++) {
                        data[i] = new Array();
                        data[i][0] = obj.DATA[i].timeStamp;
                        data[i][1] = obj.DATA[i].item_code;
                        data[i][2] = obj.DATA[i].material_name;
                        data[i][3] = obj.DATA[i].stockType;
                        data[i][4] = obj.DATA[i].physicalQt;
                        data[i][5] = obj.DATA[i].systemQt;
                        data[i][6] = obj.DATA[i].client_material_itemID;
                        data[i][7] = obj.DATA[i].saleableAdjustment;
                        data[i][8] = obj.DATA[i].nonSaleableAdjustment;
                        data[i][9] = obj.DATA[i].returnAdjustment;


                        if (data[i][4] == data[i][5]) {

                            $('#tbd1').append("<tr style='cursor: pointer'  id='" + data[i][6] + "' title='" + data[i][3] + "'><td class='data'>" + data[i][0] + "</td><td class='item_code'>" + data[i][1] + "</td><td class='material_name'>" + data[i][2] + "</td><td class='sto_tpe'>" + data[i][3] + "</td><td class='phy_qt'>" + data[i][4] + "</td><td class='sys_qt'>" + data[i][5] + "</td><td><button id='" + data[i][1] + "' style='display:none' class='btn btn-default'>Update Stock</button></tr>");

                        } else if (data[i][3] == "saleable" && data[i][7] == 1) {

                            $('#tbd1').append("<tr style='cursor: pointer'  id='" + data[i][6] + "' title='" + data[i][3] + "'><td class='data'>" + data[i][0] + "</td><td class='item_code'>" + data[i][1] + "</td><td class='material_name'>" + data[i][2] + "</td><td class='sto_tpe'>" + data[i][3] + "</td><td class='phy_qt'>" + data[i][4] + "</td><td class='sys_qt'>" + data[i][5] + "</td><td><button id='" + data[i][1] + "' style='display:none' class='btn btn-default'>Update Stock</button></tr>");

                        } else if (data[i][3] == "Nonsaleable" && data[i][8] == 1) {

                            $('#tbd1').append("<tr style='cursor: pointer'  id='" + data[i][6] + "' title='" + data[i][3] + "'><td class='data'>" + data[i][0] + "</td><td class='item_code'>" + data[i][1] + "</td><td class='material_name'>" + data[i][2] + "</td><td class='sto_tpe'>" + data[i][3] + "</td><td class='phy_qt'>" + data[i][4] + "</td><td class='sys_qt'>" + data[i][5] + "</td><td><button id='" + data[i][1] + "' style='display:none' class='btn btn-default'>Update Stock</button></tr>");

                        } else if (data[i][3] == "return" && data[i][9] == 1) {

                            $('#tbd1').append("<tr style='cursor: pointer'  id='" + data[i][6] + "' title='" + data[i][3] + "'><td class='data'>" + data[i][0] + "</td><td class='item_code'>" + data[i][1] + "</td><td class='material_name'>" + data[i][2] + "</td><td class='sto_tpe'>" + data[i][3] + "</td><td class='phy_qt'>" + data[i][4] + "</td><td class='sys_qt'>" + data[i][5] + "</td><td><button id='" + data[i][1] + "' style='display:none' class='btn btn-default'>Update Stock</button></tr>");

                        } else {

                            $('#tbd1').append("<tr style='cursor: pointer' id='" + data[i][6] + "' title='" + data[i][3] + "' onclick='update_stock(this.id,this.title)' ><td class='data'>" + data[i][0] + "</td><td class='item_code'>" + data[i][1] + "</td><td class='material_name'>" + data[i][2] + "</td><td class='sto_tpe'>" + data[i][3] + "</td><td class='phy_qt'>" + data[i][4] + "</td><td class='sys_qt'>" + data[i][5] + "</td><td><button id='" + data[i][1] + "'  class='btn btn-default'>Update Stock</button></tr>");
...
function update_stock_location(id,title,lang){
   
    var main={"client_id":id,"stock_type":title,"location_id":lang,"company_id":$("#ids_value").val(),"warehouseid":$("#warehouse_id").val()}
    $.get("locationWiseManualUpdateStock.php",main,function (result) {
       // alert(result)
        if ($.trim(result) == "Y") {


            show_modal("Manual Stock Updated Successfully");
            setTimeout(function(){
        ...
        }else if ($.trim(result) == "Already done adjustment") {


            show_modal("Already done adjustment")
        }
        else {
            ...
            function update_stock(a,b) {


                var main_query={"client_id":a,"stock_type":b,"company_id":$("#ids_value").val(),"warehouseid":$("#warehouse_id").val()}
                $.get("getDataForUpdateManualStock.php",main_query,function (ab) {
//alert(ab)
                    if ($.trim(ab) == "Y") {
                        ...
                        show_modal("Failed To Update..")
                    }else if ($.trim(ab) == "Already done adjustment") {
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-green  margin-bottom-40" >
                        ...
                        <div class="panel-body">
                            ...
                            </div><div class="col-lg-12"><div class="col-lg-10 text-center center-block"> <center><br><div class="col-lg-2"></div><select style="width: 400px;"  class="form-control " name="warehouse_id"  onchange="get_bill_type(this.value)" required="" id="warehouse_id" ></select></center><br><br></div></div>
                ...
                <div class="panel panel-green  margin-bottom-40" >
                    <div class="panel-heading" >
                        <h3 class="panel-title"><i class="fa fa-tasks"></i> Manual Stock</h3>
                    </div>
