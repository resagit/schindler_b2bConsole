            ...
            function call_header(cmp_id)
            {
                ...
                $.post("getToClientList.php", parse, function (ty) {
                    ...
                    $("#main")
                        ...
                        .updateStatus("to_company", 'NOT_VALIDATED')
                        .validateField("to_company");
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header"><a href="bulk_order_create.php"> <button class="btn btn-default pull-right"><i class="fa fa-upload"></i>Bulk Order Upload</button></a>
                         CREATE STO
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    ...
                    <form role="form" id="main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <select  class="form-control" title="Main Company" name="main_company_id1" required="" id="main_company_id1" onchange="call_header(this.value)" >
                        ...
                        <div class='panel panel-green  margin-bottom-40' id="to_container" > <div class='panel-heading' ><h3 class='panel-title'><i class='fa fa-task'></i>To Company Details</h3></div> <div class='panel-body'> <div class='row'>   <div  class='col-lg-6' ><div class='col-lg-12'><label>To  Company Name</label><div class='form-group'><select name="to_company" id="to_company" onchange="get_warehouse_to_company(this.value)"  class='form-control'></select> </div></div>  </div> <div class='col-lg-6'><div class='col-lg-12'><label>To Warehouse </label><div class='form-group'><select id="to_warehouse" name="to_warehouse"   class='form-control'><option value="">Select Warehouse</option></select></div></div></div></div></div></div>
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Cerena Reference</label>
                                    <input type="text" class="form-control" id="cerena_ref" required="" title="Cerena Reference" placeholder="Cerena Ref. Name" name="cerena_reference">
                                </div>


                                <div class="form-group">
                                    <label for="exampleInputPassword1">Contact No</label>
                                    <input type="text" class="form-control" maxlength="13"  title="Contact Number" id="c_no" placeholder="Cerena Ref. No" name="c_no">
                                </div>
                                ...
                                <div style="margin-left: -20px" class=""><div class="row">            <form role="form" id="add_items1">
                                            <div class="panel-body">
                                                ...
                                                <div class="col-lg-3">
                                                    ...
                                                    <div id="stocks" style="font-weight: bold;color:red;"></div></div>
...
//alert()
//alert(main_query.materialItemID);
                                        $.post("sto_order_in.php", main_query, function (ho) {
...
//alert(ho);
                        ...
                        fields: {
                            ...
                            main_company_id1:
                            {
                                validators: {
                                    notEmpty: {
                                        message: 'Please Select Main Company'
                ...
                function get_warehouse_to_company(a)
                {
