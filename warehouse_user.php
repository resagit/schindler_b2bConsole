...
//                        alert(warehouseOptions);
    ...
    {
        var sales_off="<?php $_SESSION['companyID']?>";
        query1 = {"sales_off": sales_off};
        $.post("get_ui_roles_warehouse.php", query1, function (hd) {
            choicess=[];
...
//                        alert(warehouseOptions);
                    if(rol==dataww[i][0])
                    {
                        ...
                        $('#append_role').append("<tr style='color: #0a94d1;font-size: 15px;'><td>"+dataww[i][1]+"</td></tr>");
...
//alert(choicess);
                    ...
                    if($.trim(role_id)==$.trim(dataww[i][0]))
                    {
                        ...
                        $('#append_role').append("<tr><td style='color: #0a94d1;font-size: 15px;'>"+dataww[i][1]+"</td></tr>");
...
//alert(z);
    ...
    function create_warehouse_user()
    {
...
//md={"kk":$("#typeid").val(),"ks":"sd"};
        ...
        $.get("createWareHouseUser.php", $('#main').serialize(), function (ho) {
            ...
            if($.trim(ho)=="Y")
            {
                $("#mes").html("Warehouse user profile create For  "+$('#company_name :selected').text()+ "  Successfully");
            ...
            {
                $("#mes").html("Failed to Create Warehouse for "+$('#company_name :selected').text()+"..");
            }
            else if($.trim(ho)=="A")
            {
            ...
            {
                $("#mes").html("Failed to Create  Warehouse "+$('#company_name :selected').text());
            }
        });
                ...
                <form role="form" id="main">
                    ...
                    <div class="panel panel-green  margin-bottom-40">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-tasks"></i> Create Warehouse User Profile</h3>
                        </div>
                            ...
                            <div class="container-fluid">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Select Warehouse</label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" required="" id="user_name" placeholder="User Name" name="user_name">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" required="" id="mobile_no" placeholder="Mobile No " name="mobile_no" title="Only Characters are required">
                                    </div>
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">User Role</label>
                                        <select id="user_role" onchange="ui_description()" name="role_id" class="form-control"></select>
                                    </div>

<table id="append_role"><tbody></tbody></table>
            ...
            fields: {
                ...
                company_name: {
                    ...
                    validators: {
                        ...
                        stringLength: {
                            min: 2,
                            max: 40,
                            message: 'The Company Name  be more than 1 and less than 40 characters long'
                        },
                        regexp: {
                            regexp: /^[a-z 0-9-]+$/i,
                ...
                client_cnt_name: {
                    ...
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[a-z 0-9-.]+$/i,
                            message: 'The  Reference Name cannot be special character'
                        }
                ...
                user_name:{
                    validators: {
                        ...
                        stringLength: {
                            min: 2,
                            max: 40,
                            message: 'The  User Name  be more than 1 and less than 40 characters long'
                        },
                        regexp: {
                            regexp: /^[a-z0-9-_.]+$/i,
                            message: 'The  User Name cannot be space or special character'
                        }
                    }
                },
                password:{
                    validators: {
                        ...
                        stringLength: {
                            min: 2,
                            max: 40,
                            message: 'The password  be more than 1 and less than 40 characters long'
                        },
                        regexp: {
                            regexp: /^[a-z0-9]+$/i,
                            message: 'The password cannot be special only character'
                        }
                    }
                },
                client_cnt_no: {
