                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Create Operational Office User
                ...
                fields: {
                    ...
                    last_name: {
                        ...
                        validators: {
                            ...
                            stringLength: {
                                min: 2,
                                max: 40,
                                message: 'Last Name be more than 1 and less than 40 characters long'
                            },
                            regexp: {
                                regexp: /^[a-z 0-9-]+$/i,
                                message: 'Last Name cannot be special character'
                            }
                    ...
                    client_cnt_name: {
                        ...
                        validators: {
                            ...
                            regexp: {
                                regexp: /^[a-z 0-9-]+$/i,
                                message: 'Reference Name cannot be number only character'
                            }
                    ...
                    mobile_no: {
                        ...
                        validators: {
                            ...
                            stringLength: {
                                min: 10,
                                max: 13,
                                message: 'The Contact No should be at least 10 and atmost 13 digit'
                            },
                            regexp: {
                                regexp: /^[0-9]+$/i,
                    ...
                    user_name:{
                        validators: {
                            ...
                            regexp: {
                                regexp: /^[a-z0-9-_]+$/i,
                                message: 'The  User Name cannot be special only character'
                            }
                        }
                    },
                    password:{
