...
//                        alert(warehouseOptions);
            ...
            function get_ui_tabs()
            {
                ...
                $.get("getUpdateRoleForCompany.php",query1,function(datas)
                {
                ...
                $.post("getUiTabsForProject_comp_new.php","",function(datas1)
                {
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#main").submit(function(e)
            {
                ...
                $.post("updaterolecompanyproject.php",query,function(returns)
                {
                    ...
                    if($.trim(returns)=="Y")
                    {
                        ...
                        show_modal("Client Role Updated Successfully");
                        //get_user_list();
                        setTimeout(function()
                        {
