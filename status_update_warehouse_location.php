    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function get_ui_tabs()
            {
                ...
                $.get("getWareHouseList.php",query,function(datas)
                {
                    ...
                    for (var i = 0; i < obj.LIST.length; i++) {
                        ...
                        datas1[i][2] = obj.LIST[i].islocationAvailable;


                        if(datas1[i][2]==1)
                        {
                            // $('#toggle-one').bootstrapToggle();
                            $("#print_ui").append("<tr id='"+datas1[i][0]+"'  ><td>"+ datas1[i][1]+"</td><td>  <input title='"+datas1[i][0]+"' value='"+datas1[i][0]+"' class='toggle-one' checked type='checkbox'>         </td></tr>")
                            $('.toggle-one').bootstrapToggle(
                                {
                        ...
                        {
                            // $('#toggle-one').bootstrapToggle();
                            $("#print_ui").append("<tr id='"+datas1[i][0]+"'  ><td>"+ datas1[i][1]+"</td><td>  <input title='"+datas1[i][0]+"' value='"+datas1[i][0]+"' class='toggle-one'  Un-checked type='checkbox'>         </td></tr>")
                    ...
                    $('.toggle-one').change(function()
                    {
                        if($(this).prop("checked")==true)
                        {
                            ...
                            var query={"warehouse_id":$(this).attr("value"),"status":1};
                            $.post("inActiveWareHouseLocation.php",query,function(xy)
                            {
//alert(xy)
                                ...
                                if($.trim(xy)=="N")
                                {
                                    ...
                                    show_modal("Once Activated, location cannot be deactivate");
                                ...
                                else  if($.trim(xy)=="Y")
                                {
                                    ...
                                    show_modal("Location Activated Successfully");

                                }
                                else if($.trim(xy)=="You can not inactive warehouse")
                                {


                                    show_modal("You can not inactive warehouse");
                                    setTimeout(function()
                                    {
                                ...
                                else if($.trim(xy)=="Please clear all order first")
                                {


                                    show_modal("Please clear all order first");
                                    setTimeout(function()
                                    {
                        ...
                        else
                        {
                            ...
                            var query={"warehouse_id":$(this).attr("value"),"status":0};
                            $.post("inActiveWareHouseLocation.php",query,function(xy)
                            {
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <ul class="nav navbar-right top-nav">
                ...
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" style="color: white;" data-toggle="dropdown"><i class="fa fa-user"></i> <?php echo $_COOKIE['user_name']?> <b class="caret"></b></a>
                    <ul class="dropdown-menu">

                        <li class="divider"></li><li data-target="#show_user" data-toggle="modal">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse" style="">
                <ul class="nav navbar-nav side-nav" id="menus_main">
                    ...
                    <li >
                        <a href="#" class="dropdown"> <i class="fa fa-windows"></i> Create Order</a>
                        <ul  style="display: none" id="create_orders">

                        </ul>
                    </li>
                    <li id="masters_menus"  style="display: none">
                        <a href="#" class="dropdown"> <i class="fa fa-windows"></i> Master Data</a>
                        <ul style="display: none">
                            <li class="sub-dropdown" > <a href="#" > <i class="fa fa-windows"></i>Create Master</a>
                                <ul style="display: none;" id="create_materials" >
                                    ...
                                    <li><a href="create_shipper.php">Create Shipper</a></li>

                                    <li><a href="create_user.php">Create Sales Office User</a></li>
                                    <li><a href="createRole.php">Create Role</a></li>


                                    <li><a href="create_material.php">Create Material</a></li>
                            ...
                            <li class="sub-dropdown"> <a href="#" > <i class="fa fa-windows"></i>Create Warehouse Master</a>
                                <ul style="display: none;font-size: 13px;padding-left: -5px;" id="create_materials">
                                    ...
                                    <li><a href="warehouse_user.php">Create Warehouse User</a></li>
                                    ...
                                    <li><a href="status_update_warehouse_user.php">Active/In-Active Warehouse Location</a></li>


                                </ul>

                            </li>
                            <li class="sub-dropdown"> <a href="#" > <i class="fa fa-windows"></i>Update Warehouse Master</a>
                                <ul style="display: none;font-size: 13px;padding-left: -5px;" id="create_materials">
                                    <li><a href="update_warehouse.php">Update Warehouse</a></li>
                            ...
                            <li class="sub-dropdown"> <a href="#" > <i class="fa fa-windows"></i>Update Master</a>
                                <ul style="display: none" id="create_materials">
                                    <li><a href="edit_client.php">Update Client</a></li>
                                    <li><a href="edit_sales_office.php">Update Sales Office</a></li>
                                    <li><a href="edit_shipper.php">Update Shipper</a></li>
                                    <li><a href="edit_warehouse.php">Update Warehouse</a></li>
                                    <li><a href="materialList.php">Update Material</a></li>


                                </ul>

                            </li>
                            <li class="sub-dropdown"> <a href="#" > <i class="fa fa-windows"></i>Assign or Assigned</a>
                                <ul style="display: none" >
                    ...
                    <li ><a href="#" class="dropdown"> <i class="fa fa-edit"></i> Update Order</a>
                        <ul  style="display: none" id="updates_order">
                    ...
                    <li ><a href="#" class="dropdown"> <i class="fa fa-archive"></i> Report</a>
                        <ul  style="display: none" id="reports">

                        </ul></li>
                    <li ><a href="#" class="dropdown"> <i class="fa fa-map-marker"></i> Track</a>
                        <ul  style="display: none" id="tracks">


                        </ul></li>
                    <li id="add_notes"  style="display: none" ><a href="#" class="dropdown"> <i class="fa fa-newspaper-o"></i> Add Notes</a>
                        <ul  style="display: none" >
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Active/In-Active Warehouse Location
                ...
                <div class="row">
                    ...
                    <table class="table table-striped"><thead><tr><th>Name</th><th>Edit</th></tr></thead>
