...
//                {
                    ...
                    for(var i = 0; i < obj.LIST.length; i++) {
                        ...
                        $("#tbd1").append("<tr style='cursor: pointer' id='"+datak[i][0]+"'><td>"+datak[i][1]+"</td><td><button class='btn btn-default assign' id='"+datak[i][0]+"'>Assigned</button></td><td></td><td></td><td></td><td></td></tr>")
                    ...
                    $(".assign").click(function()
                    {
                        ...
                        if($(this).attr("class").indexOf("assign")!="-1") {
                            ...
                            var datas = {
                                "company_id": $("#main_company_id1").val(),
                                "sales_office_id": $("#ids_value").val(),
                                "warehouse_id": $(this).attr("id")
                            };
                            $.get("unassignWareHouseToSalesOffice.php", datas, function (return_datas) {
                                ...
                                if ($.trim(return_datas) == "Y") {
                                    ...
                                    $(k).text("Unassign");
                                    $(k).removeClass("assign").addClass("dones");
                                }else if ($.trim(return_datas) == "Please clear all order first") {
