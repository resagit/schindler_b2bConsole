...
//                        alert(warehouseOptions);
            ...
            function get_ui_roles(sw)
            {

                var comp_id=sw;

                query1 = {"comp_id": comp_id};
                $.post("get_ui_company.php",query1, function (hd) {
                    choicess=[];
...
//                        alert(warehouseOptions);
            ...
            function ui_description()
            {
                ...
                query1={"sales_off":$("#company_name").val()}
...
//md={"kk":$("#typeid").val(),"ks":"sd"};
                ...
                $.get("b2bcompanyuser.php", $('#main').serialize(), function (ho) {
                    ...
                    if($.trim(ho)=="Y")
                    {
                        $("#mes").html("Created Client user Successfully");
                    ...
                    {
                        console.log(ho);
                        $("#mes").html("Failed to Create Client User..." );
                    }
                    else if($.trim(ho)=="A")
                    {
                        conosole.log(ho);
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Create User Profile</h3>
                            </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Master Client<span style="color:red;" >*</span>:</label>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">User Name<span style="color:red;" >*</span>:</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control" required="" maxlength="12" id="password"  placeholder="Password" name="password">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">User Roles<span style="color:red;" >*</span>:</label>
                                            <select  class="form-control" name="user_role" required="" id="user_role" onchange="ui_description()" >

                                                <option value="-1">Select</option>


                                            </select>
                                            <div id="" style="font-weight: bold;color:red;">
                                                <table>
                                                    <tbody id="ui_desc">
                    ...
                    last_name: {
                        ...
                        validators: {
                            ...
                            stringLength: {
                                min: 2,
                                max: 40,
                                message: 'The Name  be more than 2 and less than 40 characters long'
                            },
                            regexp: {
                                regexp: /^[a-z 0-9-]+$/i,
                                message: 'The Name cannot be special character'
