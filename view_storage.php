        ...
        <script type="text/javascript">
            ...
            function get_ui_tabs()
            {
             ...
             //   var query={"sales_id":"<?php echo $_SESSION['companyID']?>"};
                $.get("view_storage_data.php",$(this).serialize(),function(datas)
                {
//alert(datas);
...
//                    var out = new Array();
                   ...
                   for (var i = 0; i < obj.LIST.length; i++) {
                       ...
                       datas1[i] = new Array();
                       datas1[i][0] = obj.LIST[i].storageTypeId;
                       datas1[i][1] = obj.LIST[i].storageType;
                       datas1[i][2] = obj.LIST[i].height;
                       datas1[i][3] = obj.LIST[i].width;
                       datas1[i][4] = obj.LIST[i].length;
                       datas1[i][5] = obj.LIST[i].weight;
                       $("#print_ui").append("<tr id='"+datas1[i][0]+"'><td>"+ datas1[i][1]+"</td><td>"+ datas1[i][2]+"</td><td>"+ datas1[i][3]+"</td><td>"+ datas1[i][4]+"</td><td>"+ datas1[i][5]+"</td></tr>")
                   }
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <table class="table table-striped"><thead><tr><th>Storage Type</th><th>Height</th><th>Width</th><th>Length</th><th>Weight</th></tr></thead>
