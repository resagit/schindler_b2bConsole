...
//echo ($customerNo);
///createStorageCost/{companyId}/{wareHouseID}/{storageTypeID}/{billingTypeID}/{usageQuantity}/{usageUom}/{amount}/{amountUnit}/{amountCycle}/{height}/{width}/{length}/{userName}/{userType}
$url="http://".$ip."/createStorageCost/$companyId/$warehouse_id/$str_type/$bill_type/$quantity/$uom/$str_amt/$amt_unit/$amt_cycle/$str_height/$str_weight/$str_length/$user_name/BMSOperational";
//echo $url;
$ch = curl_init();
