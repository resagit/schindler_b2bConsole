...
//alert(levelOptions1);
            ...
            {
if($("#rate").val()==""){
    show_modal("Please Field All The Details")
}else {
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group" >
                                    <label for="exampleInputPassword1">Select range</label><br>
                                    <select  class="form-control" name="select_sku" required="" id="select_sku" onchange="selectsku(this.value);" >
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">From sku</label><br>
                                    <input type="text"  class="form-control" id="from_sku" disabled='disabled' placeholder="From sku" name="from_sku">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputPassword1">To sku</label>
                                    <input type="text"  class="form-control" id="to_sku" disabled='disabled'placeholder="To sku" name="to_sku">
                                </div>
                                ...
                                <div class="col-lg-12">  <center><input type="submit" data-toggle="modal" data-target="#myModal3"  class="btn btn-default" value="Add Item" onclick="add_table(this.value);">
								</center> </div><br>
                                <br><br><center><input type="button" value="Save" class="btn btn-default" style="color:#ffffff;background-color: #2bb75b;width: 130px;" id="mains"></center>
                        ...
                        <div class="panel panel-green margin-bottom-40" style="display:none;">
                            <div class="panel-heading" style="display:none;">
                                <h3 class="panel-title" style="display: none;"><i class="fa fa-tasks"></i> Consignee Details</h3>
                            </div>
                        ...
                        <div class="panel-body">
                            ...
                            <div style="margin-left: -20px" class=""><div class="row">            <form role="form" id="add_items">
                                        <div class="panel-body">
                                            ...
                                            <div class="col-lg-1">  <center><input type="submit" data-toggle="modal" data-target="#myModal3"  class="btn btn-default" value="Add Item"></center></div>
                    ...
                    $("#mains").click(function () {
                        ...
                        if($("#main").submit()) {
                           ...
                           // return false();
                            if ($("#tbd>tr").length > 0) {
                                ...
                                $.post("order_handling.php", mains_query, function (ho) {


                                    if($.trim(ho)=="Y"){
                                        show_modal("Order Handling Item Added Successfully");
                                        setTimeout(function(){
                                            window.location.reload();
                                        },2000)
                                    }else if($.trim(ho)=="N"){
                                        show_modal("Failed To Created..");

                                    }else if($.trim(ho)=="Order Handling Cost already Exist"){
                                        show_modal("Order Handling Cost already Exist   ");
                        ...
                        if (mq == false && dds == false) {
                            ...
                            if ($("#tbd>tr").length > 0) {
                                ...
                                var itmess = $("input[name='from_sku[]']")
                                    .map(function () {
                                        return $(this).val();
                                    }).get();


                                var des = $("input[name='to_sku[]']")
                                    .map(function () {
                                        return $(this).val();
                                    }).get();

//                                var amount = $("input[name='uom1[]']")
//                                    .map(function () {
//                                        return $(this).val();
//                                    }).get();
//
...
//                                    }).get();
                                ...
                                if($("#cof").val()=="")
                                {
                                    show_modal("Please Select Care Off");
                                    $("#cof").focus();
                                }else if($("#co").val()=="")
                                {
                                    show_modal("Please Select Consignee");
                                    $("#co").focus();
                                }else {
                                    $("#myModal12").fadeIn();
...
//alert(ho)
                                ...
                                show_modal("Data Added Sucessfully");
                            }
