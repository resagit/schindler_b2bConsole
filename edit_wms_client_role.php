        ...
        <script type="text/javascript">
            ...
            function setData(arr) {
                ...
                if (levelOptions == "") {
                    ...
                    $("#main_company_id1").html(levelOptions);
            ...
            function get_sale_office() {
                ...
                //alert("shdjs");
                var client_id=document.getElementById('typeid').value;
...
//                        alert(warehouseOptions);
            ...
            function get_ui_tabs()
            {
                ...
                var sales_off=$("#main_company_id1").val();
                query1 = {"sales_off": sales_off};



                $.get("getRoleForWMSclient.php",query1,function(datas)
                {
                ...
                $.post("getUiTabsForProject_wms_client.php","",function(datas1)
                {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select  class="form-control" name="main_company_id1" required="" id="main_company_id1" onchange="get_ui_tabs()" >


                                                <!--<div class="col-lg-12"></div> <div class="col-lg-6"> <form role="form" class=""><div class="form-group"><select onchange="get_sale_office()" id="typeid" class="form-control"></select></div></div><div class="col-lg-6"> <div class="form-group"><select id='typeids' onchange="get_ui_tabs()" class='form-control'></select></div></div></form>-->
                                            </select>
                                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#main").submit(function(e)
            {
                ...
                //query1 = {"sales_off": sales_off};
                var query={"main_role_id":$("#company_name").val(),"role_id":roles_id,"postions":postions,"companyID": companyId};
                $.post("updateRole_wms_client.php",query,function(returns)
                {
                    ...
                    if($.trim(returns)=="Y")
                    {
                        ...
                        show_modal("Company Role Updated Successfully");
                        //get_user_list();
                        setTimeout(function()
                        {
