        ...
        <ul class="nav navbar-nav side-nav" id="menus_main">
            ...
            <li id="masters_menus"  style="display: none">
                ...
                <ul style="display: none">
                    <li class="sub-dropdown" > <a href="javascript: void(0);" > <i class="fa fa-bars"></i> Create Master</a>
                        <ul style="display: none;" id="create_materials" >
                            <li><a href="master_data.php">Create Company</a></li>
							<li><a href='create_company_role.php'>Create Company Role</a></li>
							<li><a href='create_company_user.php'>Create Company User</a></li>
...
<?php } ?>		
					...
					<li class="sub-dropdown"> <a href="javascript: void(0);" > <i class="fa fa-bars"></i> Update Master</a>
                        <ul style="display: none" id="create_materials">
                            <li><a href="edit_client.php">Update Company</a></li>
							<li><a href="edit_company_role.php">Update Company Role</a></li>
