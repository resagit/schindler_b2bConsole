...
function call_header(xx){
    ...
    get_ui_tabs();
            ...
            function get_ui_tabs()
            {
                ...
                var query={"sales_id":$("#main_company_id1").val()};
                $.get("getActiveAndInActiveShipperList.php",query,function(datas)
                {
                    ...
                    for (var i = 0; i < obj.LIST.length; i++) {
                        ...
                        datas1[i] = new Array();
                        datas1[i][0] = obj.LIST[i].shipperID;
                        datas1[i][1] = obj.LIST[i].shipperName;

                        datas1[i][2] = obj.LIST[i].statusID;


                        if(datas1[i][2]==1)
                        {
                            // $('#toggle-one').bootstrapToggle();
                            $("#print_ui").append("<tr id='"+datas1[i][0]+"' onclick='set_roles(this.id)' ><td>"+ datas1[i][1]+"</td><td>  <input title='"+datas1[i][0]+"' value='"+datas1[i][0]+"' class='toggle-one' checked type='checkbox'>         </td></tr>")
                            $('.toggle-one').bootstrapToggle(
                                {
                        ...
                        {
                            // $('#toggle-one').bootstrapToggle();
                            $("#print_ui").append("<tr id='"+datas1[i][0]+"' onclick='set_roles(this.id)' ><td>"+ datas1[i][1]+"</td><td>  <input title='"+datas1[i][0]+"' value='"+datas1[i][0]+"' class='toggle-one'  Un-checked type='checkbox'>         </td></tr>")
                    ...
                    $('.toggle-one').change(function()
                    {
                        if($(this).prop("checked")==true)
                        {
                            ...
                            var query={"warehouse_id":idd,"status":1};

                            $.post("getUpdateShipper.php",query,function(xy)
                            {
                                ...
                                }else if($.trim(xy)=="Y")
                                {
                                    ...
                                    show_modal("Activated Successfully");
                        ...
                        else
                        {
                            ...
                            var query={"warehouse_id":idd,"status":0};
                            //alert(warehouse_id);
                            $.post("getUpdateShipper.php",query,function(xy)
                            {
                                ...
                                else if($.trim(xy)=="Y")
                                {
                                    ...
                                    show_modal("Inactivated Succcessfully");
