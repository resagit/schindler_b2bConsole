...
//                        alert(warehouseOptions);
            ...
            function search_cmp()
            {
                ...
                $.get("getDetailForBills.php",query,function (ho){

                    $("#orderHandlingCost tbody").html("");
                    $("#pickPackCost tbody").html("");
                    $("#storageCost tbody").html("");
                    var obj=JSON.parse(ho);
                    var data=new Array();
                    var data1=new Array();
                    var data2=new Array();

                    for (var i = 0; i < obj.pickPackCost.length; i++) {

                        data[i] = new Array();
                        data[i][0]=obj.pickPackCost[i].smallItemsAmount;
                        data[i][1]=obj.pickPackCost[i].mediumItemAmount;
                        data[i][2]=obj.pickPackCost[i].largeItemAmount;
                        data[i][3]=obj.pickPackCost[i].startDate;
                        data[i][4]=obj.pickPackCost[i].categoryName;

                        $("#pickPackCost tbody").append("<tr  onclick=''><td>" + data[i][0] + "</td><td>" + data[i][1] + "</td><td>" + data[i][2] + "</td><td>" + data[i][3] + "</td><td>" + data[i][4] + "</td></tr>")
                    }
                    for (var i = 0; i < obj.storageCost.length; i++) {

                        data1[i] = new Array();
                        data1[i][0]=obj.storageCost[i].storageTypeID;
                        data1[i][1]=obj.storageCost[i].billingTypeID;
                        data1[i][2]=obj.storageCost[i].usageQuantity;
                        data1[i][3]=obj.storageCost[i].usageUom;
                        data1[i][4]=obj.storageCost[i].amount;
                        data1[i][5]=obj.storageCost[i].amountUnit;
                        data1[i][6]=obj.storageCost[i].amountCycle;
                        data1[i][7]=obj.storageCost[i].height;
                        data1[i][8]=obj.storageCost[i].width;
                        data1[i][9]=obj.storageCost[i].length;
                        data1[i][10]=obj.storageCost[i].startDate;



                        $("#storageCost tbody").append("<tr  onclick=''><td>" + data1[i][0] + "</td><td>" + data1[i][1] + "</td><td>" + data1[i][2] + "</td><td>" + data1[i][3] + "</td><td>" + data1[i][4] + "</td><td>" + data1[i][5] + "</td><td>" + data1[i][6] + "</td><td>" + data1[i][7] + "</td><td>" + data1[i][8] + "</td><td>" + data1[i][9] + "</td><td>" + data1[i][10] + "</td></tr>")
                    }
                    for (var i = 0; i < obj.orderHandlingCost.length; i++) {

                        data2[i] = new Array();
                        data2[i][0]=obj.orderHandlingCost[i].inboundAmount;
                        data2[i][1]=obj.orderHandlingCost[i].outboundAmount;
                        data2[i][2]=obj.orderHandlingCost[i].stockTransferAmount;
                        data2[i][3]=obj.orderHandlingCost[i].returnInboundAmount;
                        data2[i][4]=obj.orderHandlingCost[i].rtoAmount;
                        data2[i][5]=obj.orderHandlingCost[i].fromSkuCount;
                        data2[i][6]=obj.orderHandlingCost[i].toSkuCount;
                        data2[i][7]=obj.orderHandlingCost[i].startDate;


                        $("#orderHandlingCost tbody").append("<tr  onclick=''><td>" + data2[i][0] + "</td><td>" + data2[i][1] + "</td><td>" + data2[i][2] + "</td><td>" + data2[i][3] + "</td><td>" + data2[i][4] + "</td><td>" + data2[i][5] + "</td><td>" + data2[i][6] + "</td><td>" + data2[i][7] + "</td></tr>")
                    }
                })
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2" style="padding: 0">
                                    <span style="cursor:pointer;" class="form-control" onclick="search_cmp()"><span
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="col-lg-12 ">
                            <ul class="nav nav-tabs center-block navbar-btn">
                                <li class="active" id="ins"><a href="#tab1" data-toggle="tab">Order Handling Cost</a></li>
                                <li class="list-inline" id="outs"><a href="#tab2" id="inbound_delivery" class="btn-link"
                                                                     data-toggle="tab">PIck Pack Cost</a></li>
                                <li id="stock"><a href="#tab3" data-toggle="tab">Storage Cost</a></li>
                            ...
                            <div class="tab-content"><br><br>
                                <div class="tab-pane active col-lg-12" id="tab1">
                                    <div class="panel-group" id="accordion">
                                        ...
                                        <table id="orderHandlingCost" class='table table-striped'>
                                            <thead>

                                            <tr>
                                                <th>Inbound Amount</th>
                                                <th>Outbound Amount</th>
                                                <th>Stocktransfer Amount</th>
                                                <th>Return Inbound amount</th>
                                                <th>RTO Amount</th>
                                                <th>From Sku</th>
                                                <th>To Sku</th>
                                                <th>Date</th>
                                ...
                                <div class="tab-pane" id="tab2">
                                    <div class="panel-group" id="accordion1">
                                        <table id="pickPackCost" class='table table-striped'>
                                            <thead>
                                            <tr>
                                                <th>Small Items Amount</th>
                                                <th>Medium Item Amount</th>
                                                <th>Large Item Amount</th>
                                                <th>Date</th>
                                                <th>Category Name</th>
                                ...
                                <div class="tab-pane" id="tab3">
                                    <div class="panel-group" id="accordion2">
                                        <table id="storageCost" class='table table-striped'>
                                            <thead>
                                            <tr>
                                                <th>Storage Type</th>
                                                <th>Billing Type</th>
...
//
                                        ...
                                        if(parse_id!=="") {
                                            ...
                                            $("#warehouse_id1").val($("#warehouse_id").val());
                                            var prs = $("#main").serialize();
//
                                            alert(prs);
                                            $.get("updateForPickPack.php",prs,function(ho){
                                                alert(ho);
                                                if ($.trim(ho) == "Y") {
                                                    show_modal("Pick Pack Created");
                                                } else if ($.trim(ho) == "A") {
                                                    show_modal("Pick Pack Already Exist");
                                    ...
                                    fields: {
                                        small_item_price: {
                                            message: 'The Small Item Price is not valid',
                                            validators: {
                                                notEmpty: {
                                                ...
                                                regexp: {
                                                    regexp: /^[0-9 .]+$/i,
                                                    message: 'Small Item Price Cannot Be Space Or Special Characters'
                                                }
                                        ...
                                        medium_item_price: {
                                            message: 'The Medium item price is not valid',
                                            validators: {
                                                notEmpty: {
                                                    message: 'Medium item price is required and cannot be empt'
                                                },
                                                regexp: {
                                                    regexp: /^[0-9 .]+$/i,
                                                    message: 'Medium Item Price Cannot Be Space Or Special Characters'
                                                }
                                        ...
                                        large_item_price: {
                                            message: 'The Large Item Price is not valid',
                                            validators: {
                                                notEmpty: {
                                                    message: 'Large Item Price is required and cannot be empt'
                                                },
                                                regexp: {
                                                    regexp: /^[0-9 .]+$/i,
                                                    message: 'Large Item Price Cannot Be Space Or Special Characters'
                                                }
                                        ...
                                        cat_type: {
                                            message: 'The Category Type is not valid',
                                            validators: {
                                                notEmpty: {
