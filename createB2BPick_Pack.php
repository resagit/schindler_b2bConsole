...
//echo ($customerNo);
////insertPickPackCost/{companyId}/{wareHouseID}/{smallItemPrice}/{mediumItemPrice}/{largeItemPrice}/{categoryType}/{userName}/{userType}
$url="http://".$ip."/insertPickPackCost/$companyId/$warehouse_id/$small_item_price/$medium_item_price/$large_item_price/$cat_type/$user_name/BMSOperational";
//echo $url;
$ch = curl_init();
