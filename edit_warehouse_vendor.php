        ...
        <div class="modal-dialog" style="width: 60%">
            ...
            <div class="modal-content"> <form id="Client_Details_form"   role="form">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">Warehouse Vendor Details</h4>
                    </div>
                    <div class="modal-body">
                    ...
                    <div class="panel panel-green  margin-bottom-40">
                        ...
                        <div class="panel-body">
                            ...
                            <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Warehouse Vendor Name<span style="color:red;" >*</span>:</label>
