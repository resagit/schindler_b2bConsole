...
var datas={"id":15}
                $.get("getClientList.php",datas,function(hd)
                {
            ...
            function setData(arr) {
                ...
                if (levelOptions == "") {
                    ...
                    for (var i = 0; i < obj.LIST.length; i++) {
                        ...
                        datak[i] = new Array();
                        datak[i][0] = obj.LIST[i].clientID;
                        datak[i][1] = obj.LIST[i].company_name;
...
//                        alert(warehouseOptions);
            ...
            var query1 = {"sales_off": comp_id};

                $.post("getUI_role_wms.php",query1, function (hd) {
                    choicess=[];
...
//alert(z);
            ...
            function create_shipper()
            {
                ...
                $.get("create_wms_users_data.php", $('#main').serialize(), function (ho) {

                    if($.trim(ho)=="Y")
                    {
                        $("#mes").html("WMS User Created Successfully");
                        $("#main").bootstrapValidator('resetForm', true);
                        $("#main")[0].reset();
                    }else if($.trim(ho)=="N")
                    {
                        console.log(ho);
                        $("#mes").html("Failed to Create WMS User..." );
                    }
                    else if($.trim(ho)=="A")
                    {
                        console.log(ho);
