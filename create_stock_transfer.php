...
validates();
            ...
            function setState4(ams)
            {

                $("#edit_mores_city11").val("");
                $("#edit_mores_state11").val("");
                // alert(ar+"1");
                var obj2 = JSON.parse(ams);
                //alert(obj);
               ...
               var data11=new Array();
                ...
                if(data11[0][1]!="")
                {
                    document.getElementById('edit_mores_city11').value=data11[0][0];
                    document.getElementById('edit_mores_state11').value=data11[0][1];
                }


            }
            function setStat6(ams)
            {

                $("#edit_congs_congs_city").val("");
                $("#edit_congs_congs_state").val("");
                // alert(ar+"1");
                var obj2 = JSON.parse(ams);
                //alert(obj);
                ...
                if(data11[0][1]!="")
                {
                    document.getElementById('edit_congs_congs_city').value=data11[0][0];
                    document.getElementById('edit_congs_congs_state').value=data11[0][1];
                }
...
$("#edit_care1").html(optionss)
            ...
            function load_from_consignee(tm)
            {
...
//alert(levelOptions1);
            ...
            function setState2(ams)
            {
                ...
                dgg={"pincode":ams};
                $.get("pincode.php",dgg,function(xss) {


                    var obj2 = JSON.parse(xss);
                    //alert(obj);
                    ...
                    if (data11[0][1] != "") {
                        document.getElementById('city_from').value = data11[0][0];
                        document.getElementById('state_from').value = data11[0][1];
                    }
                });
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <!-- Page Heading -->
                <div class="row"><br>  <a href="bulk_order_create.php"> <button class="btn btn-default pull-right"><i class="fa fa-upload"></i>Bulk Order Upload</button></a>
                    <div class="col-lg-12">
                ...
                <div class="row">
                    ...
                    <form role="form" id="main">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" required=""  style="text-transform: uppercase" title="Challan No" id="challan_no" name="challan_no" placeholder="Challan no">
                                            </div>
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="cerena_ref" required="" title="Reference" placeholder="Ref. Name" name="cerena_reference">
                                </div>
                        ...
                        <div class="panel panel-green margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Consignee To Details</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label  for="exampleInputPassword1">TIN</label>
                                    <input readonly type="text" value="" class="form-control" id="tin1" placeholder="TIN" name="tin1">
                                </div>
                                ...
                                <center><button class="btn btn-default"   data-toggle="modal" data-target="#myModal1Edit"   onclick=" return false">Edit</button><button class="btn btn-default" onclick="return false" data-toggle="modal" data-target="#myModal1">Add new</button>    </center>
                        ...
                        <div class="panel panel-green margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Consignee From Details</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Consignee</label><br>
                                    <select id="co_to" onchange="con_call_to(this.value)" required=""  class="form-control"  data-live-search="true"  name="co_to" >
                                    </select>
                                ...
                                <div class="form-group">
                                    <label for="exampleInputPassword1">CIN</label>
                                    <input type="text" readonly class="form-control" id="cin1_to" placeholder="CIN" name="cin1_to">
                                </div>


                                <div class="form-group">
                                    <label  for="exampleInputPassword1">TIN</label>
                                    <input readonly type="text" value="" class="form-control" id="tin1_to" placeholder="CIN" name="tin1_to">
                                </div>

                                <div class="form-group">
                                    <label for="exampleInputPassword1">Address</label>
                                    <textarea  class="form-control" id="addr1_to" placeholder="Address" readonly name="Address1_to"></textarea>
                                </div>
                                <center><button class="btn btn-default" onclick="return false" data-toggle="modal" data-target="#myModal1_from">Add new</button></center>
...
<br>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number"  class="form-control" onblur="get_pincode2(this.value)" id="congs_pin" maxlength="6" title="Only Numbers Are Required Must be 6 Digits"   required="" placeholder="Pincode" name="pincode">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">City</label>
                            <input type="text"  class="form-control" id="edit_congs_congs_city" required="" placeholder="City"  name="cityName">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">State</label>
                            <input type="text"  class="form-control" readonly id="edit_congs_congs_state" required="" placeholder="State" name="stateName">
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content"> <form id="edit_mores"   role="form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">PinCode</label>
                            <input type="number" onblur="get_pincode1(this.value)"  maxlength="6" title="Only Numbers Are Required Must be 6 Digits"  class="form-control" required="" id="pin" placeholder="Pincode" name="pincode">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">City</label>
                            <input type="text"  class="form-control" required="" id="edit_mores_city11"  placeholder="City" name="cityName">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">State</label>
                            <input type="text"  class="form-control" required="" id="edit_mores_state11" readonly placeholder="State" name="stateName">
                        </div>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content"> <form id="add_mores"   role="form">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Name</label>
                            <input type="text" pattern="^[a-zA-Z0-9-_/\'. ]{1,80}$"  title="Only Characters Are Allowed ^[a-zA-Z-_/\'. ]{80 max characters}$" required="" class="form-control" id="careOfOrConsigneeName"  placeholder="Name" name="careOfOrConsigneeName">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">PinCode</label>
                            <input type="text" onblur="get_pincode(this.value)"  maxlength="6" title="Only Numbers Are Required Must be 6 Digits"  class="form-control"  required="" id="" placeholder="Pincode" name="pincode">
                        </div>
            ...
            <form id="add_congs"  role="form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">Name</label>
                            <input type="text" class="form-control" pattern="^[a-zA-Z0-9-_\/.' ]{1,80}$" title="Name Only Characters Are Allowed ^[a-zA-Z-_\/.' ]{1,80}$"  required="" id="name1" placeholder="Name" name="name1">
                        </div>
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">PinCode</label>
                            <input type="text"  class="form-control" onblur="lookup(this.value)"  maxlength="6" title="Only Numbers Are Required Must be 6 Digits"   required="" placeholder="Pincode" name="pincode">
                        </div>
    ...
    <div class="modal fade" id="myModal1_from" data-backdrop="static" role="dialog">
        <div class="modal-dialog">
            <form id="add_from_congs"  role="form">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" id="frm_cmps_id" value="" name="companyId">


                        <div class="form-group">
                            <label for="exampleInputPassword1">Name</label>
                            <input type="text" class="form-control" style="text-transform: capitalize" id="from_cong_names" pattern="^[a-zA-Z0-9-_\/'. ]{1,80}$"  title="Name Only Characters Are Allowed example [a-zA-Z0-9-_\/'\. ]"  required="" placeholder="Name" name="name1">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Address 1</label>
                            <input type="text"  class="form-control" id="from_addr12" required="" placeholder="Address" name="Address1">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">Address 2</label>
                            <input type="text"  class="form-control" id="from_addr13" required="" placeholder="Address" name="Address2">
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">CIN</label>
                            <input type="text"  class="form-control" style="text-transform: uppercase" required="" id="add_cin" placeholder="CIN" name="CIN">
                        ...
                        <div class="form-group">
                            <label for="exampleInputPassword1">PinCode</label>
                            <input type="text"  class="form-control" onblur="setState2(this.value)"   pattern="[0-9]{6}"   maxlength="6" title="Only Numbers Are Required Must be 6 Digits"   required="" placeholder="Pincode" name="pincode">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">City</label>
                            <input type="text"  class="form-control" id="city_from" required="" placeholder="City"  name="city">
                        </div>

                        <div class="form-group">
                            <label for="exampleInputPassword1">State</label>
                            <input type="text"  class="form-control" readonly id="state_from" required="" placeholder="State" name="state">
                        </div>
                        ...
                        var bom_rate=$("input[name='bom_rate1[]']")
                            .map(function () {
                                ...
                                var main_query = {
                                    ...
                                    'companyId': $("#main_company_id1").val(),
                                    'coID': $("#cof").val(),
                                    'consigneeID': $("#co").val(),
                                    'chalanNO': $.trim($("#challan_no").val()),
                                    'chalanDate': main_date,
            ...
            $("#add_from_congs").submit(function () {
                ...
                $.post("newCondAdd.php", prs, function (dc) {
                    ...
                    if ($.trim(dc) == "Y") {
                        ...
                        $('#myModal1_from').modal('hide');
                        show_modal("Data Added Successfully");
                        //load();var client_id1=


                        load_from_consignee($("#from_cong_names").val().toLowerCase().replace(/^([a-z0-9_'-.])|\s+([a-z0-9_'-.])/g, function(letter) {
