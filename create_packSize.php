             ...
             var data={"client_material_id":client_material_id,"materialCode":materialCode,"companyId":companyId,"packQty":packQty,"packSize":packSize,"second_uom":second_uom};
                ...
                $.get("add_pack_size.php",data,function(kj)
                {
                    ...
                    if($.trim(kj)=="Y")
                    {
                        ...
                        show_modal("Pack Size  Created Succesfully");
                        // location.reload();

                    }else if($.trim(kj)=="N"){

                        show_modal("Failed to Create Pack Size ..");
                    }else if($.trim(kj)=="A"){
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                             Create Pack Size <a href="bulk_pack_size_upload.php"><button class="btn btn-primary pull-right" style="float: right">Bulk Pack Size File Upload</button></a>
                        </h1>
                        <ol class="breadcrumb">
                            <li class="active">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-green  margin-bottom-40" >
                             <div class="panel-heading" >
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Create Pack Size </h3>
                            </div>
