...
//                        alert(warehouseOptions);
            ...
            //http://" + ipaddress + "/ResagitB2B/getUiTabsForProject/B2BOperation/14/" + userNumber + "/" + userPass + "/" + userType
            ...
            function get_ui_tabs()
            {
                ...
                //  alert(sales_off);
                var query1 = {"sales_off": $("#sales_off").val()};
                $.post("getUITabsFor_warehouse.php",query1,function(tk) {
                    choicess = [];
...
//alert(vals+"vals nd cont "+count);
                ...
                if(status=='true')
                {
                    ...
                    data_pass+=d;
                    $.get("new_role_warehouse.php",data_pass, function (hd) {
                        ...
                        if($.trim(a)=='Y')
                        {
                            $("#ui_table").find("input[type='text']").attr("disabled","disabled");
                            $("#main").bootstrapValidator('resetForm', true);
                            show_modal("Warehouse User Role Created Successfully");
                            $("#main")[0].reset();
            ...
            function ui_description()
            {
                ...
                var  x='';
                $.post("get_ui_roles_oper.php", "", function (hd) {
                    $('#ui_desc').html(" ");
                    choicess=[];
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Create Warehouse Role</h3>
                            </div>
