...
//                        alert(warehouseOptions);
            ...
            {
                $('#bill_type').html("");
                    $.get("get_bill_type.php","",function (aa) {
                        var obj=JSON.parse(aa);
                        var data=new Array();

                        for(var i=0;i<obj.billType.length;i++){
                            data[i] = new Array();
                            data[i][0] = obj.billType[i].billTypeID;
                            data[i][1] = obj.billType[i].billType;

                            $('#bill_type').append("<tr><td></td><td></td><td>"+data[i][1]+"</td><td></td><td></td><td></td><td></td><td><input type='checkbox' style='margin:20' class='check_role' name='bill_id' id='bill_id'  value='"+data[i][0]+"'></td></td></tr>");
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-green  margin-bottom-40" >
                        ...
                        <div class="panel-body">
                            ...
                            </div><div class="col-lg-12"><div class="col-lg-10 text-center center-block"> <center><br><div class="col-lg-2"></div><select style="width: 400px;"  class="form-control " name="warehouse_id" onchange="get_bill_type()" required="" id="warehouse_id" ></select></center><br><br></div></div>
                ...
                <div class="row">
                    ...
                    <form role="form" id="main1" style="">



                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Assign Bill Type</h3>
                            </div>
                            <div class="panel-body">
