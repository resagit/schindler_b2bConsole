...
$url="http://".$ip."/activeInactiveShippper/$emp_id/$username/$staus/$pass/$user_type";
//http://localhost:8080/ResagitB2B/activeInactiveShippper/SID00000001/userName/0/password/userType
$ch = curl_init();
