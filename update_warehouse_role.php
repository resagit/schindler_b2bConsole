...
//                        alert(warehouseOptions);
            ...
            function get_ui_tabs()
            {
                ...
                $.get("get_ui_roles_warehouse.php","",function(datas)
                {
                ...
                $.post("getUITabsFor_warehouse.php","",function(datas1)
                {
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Role</h3>
                            </div>
            ...
            $("#main").submit(function(e)
            {
                ...
                $.post("updateRole_company.php",query,function(returns)
                {
                    ...
                    if($.trim(returns)=="Y")
                    {
                        ...
                        show_modal("Warehouse Role Updated Successfully");
                      setTimeout(function()
                      {
