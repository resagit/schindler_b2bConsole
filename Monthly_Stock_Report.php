        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="panel panel-green  margin-bottom-40" >
                    ...
                    <button type="button" style="float: right" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-expanded="true"><i class="glyphicon glyphicon-th icon-th"></i> <span class="caret"></span></button>
                    <ul  style="height:200px;position:relative;overflow:auto;padding-left:35px;margin-top:35px;margin-right:-55px;float: right" class="dropdown-menu " role="menu">
                        ...
                        <li class=""><input type="checkbox" id="material_name"> <label>Material Name</label></li>
                        <li class=""><input type="checkbox" id="client_material_itemID"> <label> Client Material Item ID</label></li>
                        <li class=""><input type="checkbox" id="uom"> <label>UOM</label></li>
                        <li class=""><input type="checkbox" id="Inbound"> <label>Inbound</label></li>
                        <li class=""><input type="checkbox" id="Outbound"> <label>Outbound</label></li>
                        <li class=""><input type="checkbox" id="openingStock"> <label>Opening Stock</label></li>
                        <li class=""><input type="checkbox" id="closingStock"> <label>Closing Stock</label></li>
    ...
    --><!----> <form class="form-horizontal"><div class="input-group"><span class="input-group-addon"><i class="fa fa-search"> </i></span><input id="filter" style="text-transform: uppercase"  placeholder="Search Item" type="search" class="form-control"></div></form><br>
                        ...
                        <table id="tabl_expr" class="table table-striped">
                            ...
                            <tr>
                                ...
                                <th class="client_material_itemID">Client Material Item ID</th>
                                <th class="uom">UOM</th>
                                <th class="Inbound">Inbound</th>
                                <th class="Outbound">Outbound</th>
                                <th class="openingStock">Opening Stock</th>
                                <th class="closingStock">Closing Stock</th>
    ...
    <script type="text/javascript">
        $(function() {
            $("#exportexcel").bind('click', function (e) {
                //   alert('')
                $("#tabl_expr").tableExport({ type: "excel", escape: "false",tableName:'Monthly_Stock_Report'+$("#typeids option:selected").text(),dates:$("#dtp_input2").val()+"_to_"+$("#dtp_input3").val(),warehousename:$("#warehouse_id option:selected").text(),Company_name:$("#main_company_id1 option:selected").text(),sales_office_name:$("#typeids option:selected").text()});
            });
