							...
							<div class="col-sm-5 form-box">
								...
								<div class="form-bottom">
									...
									<form role="form" class="center-block" style="">
										...
										<div class="form-group ">
											<Center><input type="password" title="Enter The Password" required="" class="form-control" style="width: 90%;height: 40px" name="pass" placeholder="Password" maxlength="12"></Center>
										</div>
										<br>
										<center><input type="submit" class="btn btn-default" style="background-color:#00bcff;color:#ffffff;height:50px;width: 80%" value="Login"></center>
									</form>
								</div>
							</div>
						</div>
