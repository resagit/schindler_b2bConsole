    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function set_sale_office(arr) {
                ...
                dataw = new Array();
                var sales_off = "<option value=''>Select</option>";
                var out = new Array();
            ...
            function setData(arr) {
                ...
                var obj = JSON.parse(arr);
                datak = new Array();
                var levelOptions = "<option value='0'>Select</option>";
                var out = new Array();
                    ...
                    <div class="panel panel-green  margin-bottom-40" >
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12"></div> <div class="col-lg-6"> <form role="form" class=""><div class="form-group"><select onchange="get_sale_office()" id="typeid" class="form-control"></select></div></div><div class="col-lg-6"> <div class="form-group"><select id='typeids' class='form-control'></select></div></div></form></div>

                                <center><a href="material_List_Template.xlsx" download="material_List_Template.xlsx"><br><br><button class="btn btn-primary"><i class="fa fa-download"></i> Download Material File</button></a>&nbsp;&nbsp;&nbsp;<button data-toggle="modal" data-target="#myModal_upload_image" class="btn btn-default"><i  class="fa fa-upload"></i> Upload Excel File</button></center>
                            </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#files").fileinput({
                ...
                //   dropZoneEnabled: t,
                //  uploadAsync: false,
                uploadUrl: "save_file.php" // your upload server url
                ...
                if(data.response.messages!="Failed")
                {
                    ...
                    $("form").submit(function()
                    {
                        ...
                        $.get("send_files.php",datas,function(trr)
                        {

                                if($.trim(trr)=="Y")
                                {
                                $("#myModal3").modal("hide");
                                    show_modal("Material Added Successfully");
                                    $("#myModal3").modal("hide");
