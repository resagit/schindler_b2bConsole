...
function view_table(ii)
{
   //alert(ii+"view_table");

    $("#tbd").html("<center><img src='loader1.gif'></center>");
    var query={'companyId':ii};
$.post("get_secondary_uom_data.php",query,function(vt){
    var obj1=JSON.parse(vt);
    var datas= new Array();
    $("#tbd").html("");
    for (var i = 0; i < obj1.LIST.length; i++)
    {
        datas[i]=new Array();
        datas[i][0]=obj1.LIST[i].id;
        datas[i][1]=obj1.LIST[i].client_material_id;
        datas[i][2]=obj1.LIST[i].item_code;
        datas[i][3]=obj1.LIST[i].material_name;
        datas[i][4]=obj1.LIST[i].from_qty;
        datas[i][5]=obj1.LIST[i].from_uom;
        datas[i][6]=obj1.LIST[i].fromUomName;
        datas[i][7]=obj1.LIST[i].to_qty;
        datas[i][8]=obj1.LIST[i].to_uom;
        datas[i][9]=obj1.LIST[i].toUomName;
        datas[i][10]=obj1.LIST[i].isActive;
...
if( datas[i][10]==1)
{
    $("#tbd").append("<tr id='"+datas[i][0]+"' ><input type='hidden' id='client_id' value='"+datas[i][1]+"'><td>"+ datas[i][2]+"</td><td>"+ datas[i][3]+"</td><td>"+ datas[i][4]+"</td><td><input type='hidden' value='"+datas[i][5]+"'>"+ datas[i][6]+"</td><td>"+datas[i][7]+"</td><td><input type='hidden' value='"+datas[i][8]+"'>"+ datas[i][9]+"</td><td>  <input  id='"+datas[i][1]+"' name='"+ datas[i][5]+"' alt='"+datas[i][8]+"' title='"+datas[i][7]+"'  value='In-Active' class='btn btn-primary'  type='button' onclick='inactive_status(this.id,this.title,this.alt,this.name);' ></td><td><button value='"+ datas[i][1]+","+datas[i][2]+","+ datas[i][3]+" ,"+datas[i][4]+","+datas[i][5]+","+datas[i][6]+","+datas[i][7]+","+datas[i][8]+","+datas[i][9]+"' onclick='edit_this(this.value);' class='btn btn-primary'>Edit</button> </td></tr>");
...
//        });
    ...
    $("#tbd").append("<tr id='"+datas[i][0]+"' ><input type='hidden' value='"+datas[i][1]+"'><td>"+ datas[i][2]+"</td><td>"+ datas[i][3]+"</td><td>"+ datas[i][4]+"</td><td><input type='hidden' value='"+datas[i][5]+"'>"+ datas[i][6]+"</td><td>"+datas[i][7]+"</td><td><input type='hidden'  value='"+datas[i][8]+"'>"+ datas[i][9]+"</td><td>  <input  id='"+datas[i][1]+"' name='"+ datas[i][5]+"' alt='"+datas[i][8]+"' title='"+datas[i][7]+"'   value='"+datas[i][10]+"' class='btn btn-success' type='button' >In-Active</td></tr>");
//    $('.toggle-one').bootstrapToggle(
//        {
//
//            on: 'In-Active',
...
//        }
       ...
       // var j= $(this).attr("pattern");
        //var o= $(this).attr("value");
        var cmp_id=$("#main_company_id1").val();

//alert($("#main_company_id1").val());
        datas = new Array();
        ...
        //alert(query1.quantity);
        $.post("update_secondary_inactive.php", query1, function (ret) {
           //alert(ret);
            if(ret=="Y")
            {
                show_modal("In-Activate Successfully");
            }
            else
            {
                show_modal("Failed To Inactive");
            }
...
function inactive_status(k,m,n,p) {
   ...
   // alert(query1.quantity);
    $.post("update_secondary_inactive.php", query1, function (ret) {
       // alert(ret);
        ...
        {
            show_modal("In-Activate Successfully");
            view_table($("#main_company_id1").val())
        }
        else
        {
            show_modal("Failed To Inactive");
...
//
//
//                $.get("get_active_uom_data.php",$(this).serialize(),function (hoi){
//                    alert(hoi+"uom_detauiks");
//                    var objs = JSON.parse(hoi);
//                    var levelOptions2="";
//                    var uomd=new Array();
////alert(uom_d);
//
...
//
//                    }
//                    document.getElementById("uom1").innerHTML =levelOptions2 ;
////alert(levelOptions2);
//                });
//
//            }
            ...
            function edit_this(bb)
            {
             // alert(bb);

              var splice=bb.split(",");

//alert(splice[0]+"client_mat_id");
//                alert(splice[1]);
//alert("Eddd");
               var mat_id=splice[0];
                var item=splice[1];
                var desc=splice[2];
               var from_qty=splice[3];
                var from_uom_value=splice[4];
                var from_uom=splice[5];
                var to_qty=splice[6];
                var to_uom_value=splice[7];
                var to_uom=splice[8];
...
//                alert( desc+"desc");
                ...
                $("#des1").val(desc);
                //$("#uom1").val(from_uom);
                $("#new_uom").val(from_uom_value);
                $("#uom1").append("<option value='"+from_uom_value+"'>"+from_uom+"</option>");
                $("#quantity1").val(to_qty);
                $("#base_uom").val(to_uom);
$("#base_uomss").val(to_uom_value);
            ...
            <form role="form" id="add_items" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" style="padding-left:10px;padding-right: 10px;">Edit Secondary Uom</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                            ...
                            <div class="panel panel-green  margin-bottom-40" style="">
                                <div class="panel-heading" style="">
                                    <h3 class="panel-title"><i class="fa fa-tasks"></i>Edit Secondary Uom</h3>
                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12">
                                                <table class="table table-striped">
                                                    ...
                                                    <tr>
                                                      <input type='hidden' id="mat_id" value="" > <td> <input type="text"  class="form-control"  id="item"  name='item' value="" disabled></td><td> <input type="text"   class="form-control" id="des1"  name='des1' disabled></td><td> <input  type="hidden" id="new_uom" value=""><select id="uom1" style="width:100px;"  name='uom1'   class="form-control"  data-live-search="false" required="" title="Please select a UOM ..."></select></td><td> <input type="number" style="" id="quantity1"  name='quantity1'  class="form-control" ></td><td><input  class="form-control"  id="base_uom"  name='base_uom' disabled><input type="hidden" id="base_uomss" value=""</td></tr>
                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <br><br><center><input type="button" value="Update" class="btn btn-primary" style="background-color: #2bb75b;width: 130px;" id="mains"></center>
                ...
                <div class="row">
                    <div class="col-lg-12"> <br>
                        <h1 class="page-header">
                            Update Secondary Uom For Material
                        </h1>
...
//                    });
                    ...
                    $("#mains").click(function () {
                        ...
                        var base_uoms=$("#base_uomss").val();
                        var new_uoms=$("#new_uom").val();
                        //alert(companyid+"kk");
                        //alert(mat_id);
                        ...
                        $.post("edit_secondary_uom.php", main_query1, function (cvc) {
