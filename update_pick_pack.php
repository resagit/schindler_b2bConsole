            ...
            function search_cmp()
            {
                ...
                $.get("getDetailForBills.php",query,function (ho){
                    ...
                    for (var i = 0; i < obj.pickPackCost.length; i++) {
                        ...
                        data[i][3]=obj.pickPackCost[i].categoryName;

                        $("#small_item_price").val(data[i][0]);
                        $("#medium_item_price").val(data[i][1]);
                        $("#large_item_price").val(data[i][2]);
                        $("#cat_type").val(data[i][3]);
            ...
            <div class="container-fluid">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-2" style="display: none">
                                    <span style="cursor:pointer;" class="form-control" onclick=""><span
                ...
                <div class="row">
                    ...
                    <form role="form" id="main" >
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Pick Pack Details</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <label for="exampleInputPassword1">Small Item Price<span style="color:red;" >*</span>:</label>
                                        <input type="text"  class="form-control" id="small_item_price"  placeholder="Small Item Price" name="small_item_price">
                                    </div>
                                </div>
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Medium Item Price<span style="color:red;" >*</span>:</label>
                                        <input type="text"  class="form-control" id="medium_item_price"  placeholder="Medium Item Price" name="medium_item_price">
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Large Item Price<span style="color:red;" >*</span>:</label>
                                        <input type="text"  class="form-control" id="large_item_price"  placeholder="Large Item Price" name="large_item_price">
                                    </div>
                                </div>
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Category Type</label>
                                        <select  class="form-control" name="cat_type" required="" id="cat_type"  >

                                            <option value=" ">Select</option>
                                            <option value="FIXED">FIXED</option>"bill
