            ...
            function get_bill_type()
            {
                ...
                $.get("getDataForManualStock.php",main,function (aa) {
                    ...
                    for(var i=0;i<obj.DATA.length;i++){
                        ...
                        $('#bill_type').append("<tr><td class='data'>"+ data[i][0] +"</td><td class='item_code'>"+ data[i][1] +"</td><td class='material_name'>"+ data[i][2] +"</td><td class='sto_tpe'>"+ data[i][3] +"</td><td class='phy_qt'>"+ data[i][4] +"</td><td class='sys_qt'>"+ data[i][5] +"</td></tr>");
                    ...
                    <form role="form" id="main" style="">
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="col-lg-3"></div>
                                    <div style="height: 80px;alignment: center" class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <table class="table table-striped ">
                                                ...
                                                <tbody id="bill_type" style="overflow-y: auto">
...
//
                                            alert(prs);
                                            $.get("createBillTypeAssign.php",prs,function(ho){
                                                alert(ho);
                                                if ($.trim(ho) == "Y") {
                                                    show_modal("Assign Bill Type Created");
                                                    $("#main")[0].reset();
                                                } else if ($.trim(ho) == "A") {
                                                    show_modal("Assign Bill Type Already Exist");
