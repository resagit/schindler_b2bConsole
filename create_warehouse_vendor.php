...
if (isset($_SESSION['user_names'])) {
			...
			<script type="text/javascript">
				...
				function change_cmp_type(a)
				{
					...
					if (a == "8")
					{
						...
						$("#check_sales").html(' <div class="col-lg-5"></div><div class="col-lg-5"><br><br><label>Work as a Sales Office</label><br><br><input type="radio" id="check_wms" name="check_wms" value="Y" class="radio-inline">&nbsp;Yes &nbsp;&nbsp; <input style="margin-top: 5px;" type="radio" name="check_wms" value="-" class="radio-inline">&nbsp;No</div>');
							...
							<form role="form" id="main">
								...
								<!-- <div class="panel panel-green  margin-bottom-40">
									<div class="panel-heading">
										<h3 class="panel-title"><i class="fa fa-tasks"></i> Warehouse Vendor</h3>
									</div>
											...
											<div class="row">
												<div class="col-lg-6" style="height: 70px">
													<div class="form-group">
														<label for="exampleInputEmail1q">Warehouse Vendor<span style="color:red;" >*</span>:</label>
														<select  class="form-control" name="company_type" required="" onchange="change_cmp_type(this.value)" id="company_type" >
									...
									<div class="panel-body">
										...
										<div style="margin-left: -15px;height: 80px;display:none" class="col-lg-6">
											<div class="form-group">
												...
												<input type="text"  class="form-control" id="client_name"  placeholder="Name" value="-" name="client_name">
											</div>
										</div>
	...
	//alert(ert);
														...
														$('#main').bootstrapValidator({
																	...
																	if ($("#client_state").val() != "" && $("#client_city").val() != "") {
																		...
																		$.get("client_create.php", main_query, function (ho) {
																			...
																			if ($.trim(ho) == "Y") {
																				...
																				show_modal($('#company_type option:selected').text() + " Warehouse Vendor Created Successfully");
															...
															fields: {
																company_type: {
																	message: 'The please select is not valid',
																	validators:
																					{
																						notEmpty: {
																...
																client_name: {
																	...
																	validators: {
																		...
																		regexp: {
																			regexp: /^[a-z . 0-9 ]+$/i,
																			message: 'The Name should be characters'
																		}
																...
																client_city: {
																	...
																	validators: {
																		...
																		stringLength: {
																			min: 2,
																			max: 150,
																			message: 'The City Name  be more than 1 and less than 150 characters long'
																		},
																		regexp: {
																			regexp: /^[a-z() ]+$/i,
																			message: 'The City Name should be characters'
																		}
																...
																client_state: {
																	...
																	validators: {
																		...
																		stringLength: {
																			min: 2,
																			max: 150,
																			message: 'The State Name  be more than 1 and less than 150 characters long'
																		},
																		regexp: {
																			regexp: /^[a-z ]+$/i,
																			message: 'The State Name should be characters'
																		}
																...
																client_cnt_name: {
																	...
																	validators: {
																		stringLength: {
																			min: 2,
																			max: 40,
																			message: 'The  Contact Name  be more than 1 and less than 40 characters long'
																		},
																		regexp: {
																			regexp: /^[a-z ]+$/i,
																			message: 'The  Contact Name cannot be number only character'
																		}
																...
																client_cnt_no: {
																	...
																	validators: {
																		...
																		stringLength: {
																			min: 10,
																			max: 12,
																			message: 'The Mobile number should be at least 10 and atmost 12 digit'
																		},
																		regexp: {
																			regexp: /^[0-9]+$/i,
