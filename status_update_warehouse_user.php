    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function get_ui_tabs()
            {
                ...
                $.get("getWarehouseAllUser.php",query,function(datas)
                {
                    ...
                    for (var i = 0; i < obj.LIST.length; i++) {
                        ...
                        if(datas1[i][3]==1)
                        {
                            ...
                            $("#print_ui").append("<tr id='"+datas1[i][0]+"' onclick='set_roles(this.id)' ><td>"+ datas1[i][1]+"</td><td>"+ datas1[i][2]+"</td><td>  <input title='"+datas1[i][2]+"' value='"+datas1[i][0]+"' class='toggle-one' checked type='checkbox'>         </td></tr>")
                            $('.toggle-one').bootstrapToggle(
                                {
                    ...
                    $('.toggle-one').change(function()
                    {
                        ...
                        else
                        {
                            ...
                            var query={"emp_id":$(this).attr("value"),"user_name":$(this).attr("title"),"status":0};
                            $.post("company_user_staus.php",query,function(xy)
                            {
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                       ...
                       Active/In-active Warehouse User
