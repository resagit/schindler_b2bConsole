        ...
        <div class="panel-body">
            ...
            <div style="margin-left: -20px" class=""><div class="row">            <form role="form" id="add_items">
                    ...
                    <div class="col-lg-12">
                            ...
                            <div class="col-lg-1" style="">    <div class="form-group">

                                    <select id="uom" style="width:100%;" class="form-control"  data-live-search="false" required="" title="Please select a UOM ...">
...
//alert(main_query.consigneeRefName)
