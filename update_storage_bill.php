            ...
            function search_cmp()
            {
               ...
               $.get("getDetailForBills.php",query,function (ho){
                   ...
                   for (var i = 0; i < obj.storageCost.length; i++) {
                       ...
                       data[i] = new Array();
                       data[i][0]=obj.storageCost[i].storageTypeID;
                       data[i][1]=obj.storageCost[i].billingTypeID;
                       data[i][2]=obj.storageCost[i].usageQuantity;
                       data[i][3]=obj.storageCost[i].usageUom;
                       data[i][4]=obj.storageCost[i].amount;
                       data[i][5]=obj.storageCost[i].amountUnit;
                       data[i][6]=obj.storageCost[i].amountCycle;
                       data[i][7]=obj.storageCost[i].height;
                       data[i][8]=obj.storageCost[i].width;
                       data[i][9]=obj.storageCost[i].length;

                       $("#str_type").val(data[i][0]);
                       $("#bill_type").val(data[i][1]);
                       $("#quantity").val(data[i][2]);
                       $("#uom").val(data[i][3]);
                       $("#str_amt").val(data[i][4]);
                       $("#amt_unit").val(data[i][5]);
                       $("#amt_cycle").val(data[i][6]);
                       $("#str_height").val(data[i][7]);
                       $("#str_weight").val(data[i][8]);
                       $("#str_length").val(data[i][9]);
                   }
               })
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-green  margin-bottom-40" >
                        ...
                        <div class="panel-body">
                            ...
                            </div><div class="col-lg-12"><div class="col-lg-8 text-center center-block"> <center><br><div class="col-lg-4"></div><select style="width: 400px;"  class="form-control " name="warehouse_id" onchange="search_cmp()" required="" id="warehouse_id" ></select>
                                   </center>
                                    </div>
                                <br>
                ...
                <div class="row">
                    ...
                    <form role="form" id="main" >
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Storage Bill Details</h3>
                            </div>
                            <div class="panel-body">
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select  class="form-control" name="str_type" required="" id="str_type"  >
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Billing Type<span style="color:red;" >*</span>:</label>
                                        <select  class="form-control" name="bill_type" required="" id="bill_type"  >
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Quantity<span style="color:red;" >*</span>:</label>
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="uom" placeholder="UOM" name="uom">
                                    </div>
                                </div>
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Amount<span style="color:red;" >*</span>:</label>
                                        <input type="text"  class="form-control" id="str_amt"  placeholder="Amount" name="str_amt">
                                    </div>
                                </div>
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Amount Unit<span style="color:red;" >*</span>:</label>
                                        <input type="text"  class="form-control" id="amt_unit" placeholder="Amount Unit" name="amt_unit">
                                    </div>
                                </div>
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Amount Cycle<span style="color:red;" >*</span>:</label>

                                        <select  class="form-control" name="amt_cycle" required="" id="amt_cycle"  >
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="str_height" placeholder="Height" name="str_height">
                                    </div>
                                </div>
                                ...
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text"  class="form-control" id="str_weight"  placeholder="Weight" name="str_weight">
                                    </div>
                                </div>
                                <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                                    <div class="form-group">
                                        <label for="exampleInputPassword1">Length<span style="color:red;" >*</span>:</label>
                                        <input type="text"  class="form-control" id="str_length" placeholder="Length" name="str_length">
                                    </div>
                                </div>


                            </div>
                            <center><input type="submit" value="Save" class="btn btn-default" style="color:#ffffff;background-color: #2bb75b;width: 130px;" id="mains"></center><br>
                        </div>
...
//
                                            ...
                                            $("#main").bootstrapValidator('resetForm', true);
                                            $.get("updateB2BStorage_bill.php",prs,function(ho){

                                                if ($.trim(ho) == "Y") {
                                                    show_modal("Storage Bill Updated");
...
//
                                    ...
                                    fields: {
                                        ...
                                        str_type: {
                                            message: 'The Storage Type is not valid',
                                            validators: {
                                                notEmpty: {
                                                    message: 'Please Select Storage Type'
                                                }
                                        ...
                                        bill_type: {
                                            message: 'The Bill Type is not valid',
                                            validators: {
                                                notEmpty: {
                                        ...
                                        str_amt: {
                                            ...
                                            validators: {
                                                notEmpty: {
                                                    ...
                                                    regexp: /^[0-9 .]+$/i,
                                                    message: 'Amount Cannot Be Space Or Special Characters'
                                                }
                                        ...
                                        amt_unit: {
                                            message: 'The Amount Unit is not valid',
                                            validators: {
                                                notEmpty: {
                                                    message: 'Please Select Amount Unit'
                                                },regexp: {
                                                    regexp: /^[0-9 .]+$/i,
                                                    message: 'Amount Unit Cannot Be Space Or Special Characters'
                                                }
                                        ...
                                        amt_cycle: {
                                            message: 'Amount Cycle is not valid',
                                            validators: {
                                                notEmpty: {
                                                    message: 'Amount Cycle is required and cannot be empty'
                                                }
