...
$client_name=str_replace('\\','`',str_replace("/","~",$client_name));
$company_name=urlencode($_GET['company_name']);
$company_name=str_replace('\\','`',str_replace("/","~",$company_name));
...
$client_add1=urlencode(str_replace('\\','`',str_replace("/","~",$_GET['client_add1'])));
$client_add2=urlencode(str_replace('\\','`',str_replace("/","~",$_GET['client_add2'])));
...
$client_bank_branch=$_GET['client_bank_branch'];
} else {
	$client_bank_branch="-";
}
...
//echo ($customerNo);
$url="http://".$ip."/createB2BClientSalesOffice/$client_name/$client_mobile/$client_alt_mobile/$company_name/$client_email/$client_pan/$client_city/$client_state/$client_add1/$client_add2/$client_pin/$client_bank/$client_acc_no/$client_ifsc/$client_bank_branch/$company_type/13/8/$client_tin/$client_cin/$client_cnt_name/$client_cnt_no/$user_name/$pass/BMSOperational/$client_gstin/$client_country";
//echo $url;
$ch = curl_init();
