...
?>
  ...
  //  create_me(hd);
    ...
    function create_me(yt)
    {
        ...
        for(var i = 0; i < obj.packsizeDetails.length; i++)
        {

            datakk[i]=new Array();
            datakk[i][0]=obj.packsizeDetails[i].itemCode;
            datakk[i][1]=obj.packsizeDetails[i].material_name;
            datakk[i][2]=obj.packsizeDetails[i].baseUom1;
            datakk[i][3]=obj.packsizeDetails[i].packQuantity;
            datakk[i][4]=obj.packsizeDetails[i].packSize;
            datakk[i][5]=obj.packsizeDetails[i].packuom;


                $("#tbd1").append("<tr><td class='item_code'>" + datakk[i][0] + "</td><td class='material_name'>" + datakk[i][1] + "</td><td class='baseuom'> " + datakk[i][2] + "</td><td>" + datakk[i][3] + "</td><td>" + datakk[i][4] + "</td><td>" + datakk[i][5] + "</td></tr>");
...
var warehouse_data="";
            ...
            for(var i = 0; i < obj.LIST.length; i++)
            {
                ...
                edit_item[i][15]=obj.LIST[i].QrCodeStatus;
				...
				var op=edit_item[i][3];
				console.log(op);
				$('#base_uom').val(op).attr("selected", "selected");
                //$('#base_uom').val(op);
				//val(op).attr("selected", "selected"); .attr("selected", "selected");
...
var data_query={"company_id":$("#typeid").val()};
            ...
            $.post("get_packsize_list.php",data_query,function(hd) {
               //  alert(hd+"mateirlal");
                create_me(hd);
                //alert($("#typeid").val()+"company");
            ...
            <form role="form" id="update_material" >
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title"> Edit Material PackSize</h4>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="row">
                                ...
                                <div class="panel panel-green  margin-bottom-40" style="border: 1px solid #00a0d2;">
                                    <div class="panel-heading" style="background-color: #00a0d2;">
                                        <h3 class="panel-title"><i class="fa fa-tasks"></i> Edit Material PackSize</h3>
                                    </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    ...
                                                    <div class="form-group">
                                                        <label >SKU ID:</label>
                                                        <input type="text"  class="form-control"   placeholder="SKU ID" id="material_id" name="material_id">
                                                    </div>
                                                </div>
                                                <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        <label >SKU Description:</label>
                                                        <input type="text"  class="form-control"  placeholder="SKU Name" id="material_name" name="material_name">
                                                    </div>
                                                 ...
                                                 <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group" id="cos">
                                                        ...
                                                        <!--<select  class="form-control" name="base_uom" required="" id="base_uom" ></select>-->
														<select class="form-control" name="base_uom" id="base_uom">
															<?php
															$i=1;
															foreach($val->LIST as $row){ ?>
																<option value='<?php echo $row->unitOfMeasurement; ?>'><?php echo $row->unitOfMeasurement; ?></option>
															<?php } ?>
														</select>
                                                    </div>
                                                    <br>
                                                ...
                                                <!-- <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        ...
                                                        <!-- <div class="row" style="padding-left:15px;"> -->
                                                            ...
                                                            <!-- <select style="width:200px; float:left;"  class="form-control" name="base_uom" id="base_uom" required=""> -->
                                                                <?php /*
                                                                $i=1;
                                                                foreach($val->LIST as $row){ ?>
                                                                    <option value='<?php echo $row->unitOfMeasurement; ?>'><?php echo $row->unitOfMeasurement; ?></option>
												...
												<div class="col-lg-6 hide" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        <label >SKU Price:(rupees)</label>
                                                        <input type="text" step="any"  class="form-control"  placeholder="SKU Price" id="material_price" name="material_price">
                                                    </div>
                                                ...
                                                <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"   class="form-control"  placeholder="SKU Height" id="material_height" name="material_height">
                                                    </div>

                                                </div> <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        <label >SKU Width:(gram)</label>
                                                        <input type="text"  class="form-control"  placeholder="SKU Width" id="material_width" name="material_width">
                                                    </div>
                                                ...
                                                <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"   class="form-control" id="material_length" placeholder="SKU Length"  name="material_length">
                                                    </div>

                                                </div>
                                                <div class="col-lg-6 hide" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        <label >SKU Net Weight:(cm)</label>
                                                        <input type="text"  class="form-control"  placeholder="SKU Net Weight" id="material_new_weight" name="material_new_weight">
                                                    </div>

                                                </div>
                                                <div class="col-lg-6 hide" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        <label >SKU Gross Weight:(gram)</label>
                                                        <input type="text"  class="form-control" placeholder="SKU Gross Weight" id="material_gross_weight" name="material_gross_weight">
                                                    </div>
                                                ...
                                                <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text"  class="form-control"  placeholder="SKU Order Quantity"  id="material_order_quantity" name="material_order_quantity">
                                                    </div>
                                                ...
                                                <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                    ...
                                                    <div class="col-lg-6" style="height: 80px;max-height: 100px">
                                                        <div class="form-group">
                                                            <label for="exampleInputPassword1">Bar code/ QR Code </label><br>
                                                            <select  class="form-control" name="qrcode" required="" id="qrcode">
                                                                <option value="">Select</option>
                                                                <option value="Y">Yes</option>
                                                                <option value="N">No</option>
                                                            </select>
    ...
    <div id="page-wrapper">
        ...
        <div class="container-fluid">
            ...
            <div class="panel panel-green  margin-bottom-40" >
                <div class="panel-heading" >
                    <h3 class="panel-title"><i class="fa fa-tasks"></i>Material PackSize List</h3>
                </div>
...
--><!----> <form class="form-horizontal"><div class="input-group"><span class="input-group-addon"><i class="fa fa-search"> </i></span><input id="filter" style="text-transform: uppercase"  placeholder="Search Item" type="search" class="form-control"></div></form><br>
                    ...
                    <table data-role="table" data-mode="columntoggle" class=" table table-striped" id="myTable" data-filter="true" data-input="#filterTable-input">
                        <thead>
                        <tr>
                            <th class="item_code">Material Code</th>
                            <th class="material_name">Material Description</th>
                            <th class="UOM">Base UOM</th>
                            <th class="UOM">Pack Quantity</th>
                            <th class="UOM">Pack Size</th>
                            <th class="UOM">Pack UOM</th>
