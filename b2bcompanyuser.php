...
session_start();
$fields_string="";
$company_type=urlencode($_GET['company_name']);
...
//echo ($customerNo);
$url="http://".$ip."/createSalesOfficeUser/$client_name/$last_name/$user_names/$password/BMSclient/$mobile_no/$company_type/$user_name/BMSOperational/$user_role";//echo $url;
$ch = curl_init();
