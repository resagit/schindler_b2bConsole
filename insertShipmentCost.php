...
//echo ($customerNo);
$url="http://".$ip."/insertShipmentCost/$order_id1/$challan_no/$companyId/$warehouse_id/$dates/$amount/shipment/$userNumber/$user_type";
$ch = curl_init();
