...
//alert(z);
            ...
            function setState(ams)
            {
                ...
                if(data11[0][1]!="")
                {
                    ...
                    document.getElementById('warehouse_state').value=data11[0][1];
                }
            ...
            function create_shipper()
            {
                ...
                if($("#shipper_state").val()!="" && $("#shipper_city").val()!="")
                {
...
//md={"kk":$("#typeid").val(),"ks":"sd"};
                    $.post("createB2Bwarehouse.php", $('#main').serialize(), function (ho) {
                        ...
                        //  $("#mes").html(ho);
                        if ($.trim(ho) == "Y") {
                            show_modal("Warehouse for " + $('#company_name :selected').text() + "  Created");
                            $("#main").bootstrapValidator('resetForm', true);
                            $("#main")[0].reset();
                        }
                        else if ($.trim(ho) == "A") {
                            show_modal("Warehouse Already Exist for " + $('#company_name :selected').text() + "..");
                        }

                        else if ($.trim(ho) == "N") {
                            show_modal("Failed to Create Warehouse for " + $('#company_name :selected').text() + "..");
                        } else {
                            show_modal("Failed to Create  Warehouse for " + $('#company_name :selected').text());
                        }
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="panel panel-green  margin-bottom-40">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-tasks"></i> Create Shipper</h3>
                            </div>
                                ...
                                <div class="container-fluid">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Master Company</label>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"    class="form-control" required="" id="warehouse_mob" placeholder="Mobile no." name="warehouse_mob" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Address 1</label>
                                            <input type="text"  class="form-control"  required="" id="shipper_add1"   placeholder="Address" name="warehouse_add1">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Address 2</label>
                                            <input type="text"  class="form-control" required="" id="shipper_add2" placeholder="Address" name="warehouse_add2">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text"  class="form-control"  id="shipper_city"  placeholder="City" name="warehouse_city">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">State</label>
                                            <input type="text"  class="form-control"  id="warehouse_state" readonly placeholder="State" name="warehouse_state">
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Email ID</label>
                                            <input type="email"    class="form-control" required="" id="warehouse_email" placeholder="Email ID" name="warehouse_email" >
                                        </div>

                                        <div class="form-group">
                                            <label for="exampleInputPassword1">CIN</label>
                                            <input type="text"    class="form-control" required="" id="shipper_cin" placeholder="Contact name" name="contact_name" >
                                        </div>
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Contact no.</label>
                                            <input type="text"    class="form-control" required="" id="shipper_vat" placeholder="Contact no" name="contact_no" >
                                        </div>
                ...
                fields: {
                    ...
                    contact_no: {
                        ...
                        validators: {
                            ...
                            regexp: {
                                regexp: /^[0-9-]+$/i,
                                message: 'The  Contact No cannot be characters only number'
                            }
                    ...
                    contact_name: {
                        ...
                        validators: {
                            notEmpty: {
                                message: 'The Contact name no is required and cannot be empty'
                            },
                            stringLength: {
                                min: 2,
                                max: 40,
                                message: 'The Contact Name no be more than 2 and less than 40 characters long'
                            },
                            regexp: {
                                regexp: /^[a-z 0-9-]+$/i,
                                message: 'The Contact Name cannot be special character'
                            }
