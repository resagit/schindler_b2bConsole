...
function create_shipper()
{
    ...
    if($("#shipper_code").val()!="" && $("#shipper_name").val()!="")
    {
        ...
        show_modal("<center><img src='loader1.gif'></center>");
//md={"kk":$("#typeid").val(),"ks":"sd"};
        $.get("createB2BClientShipper.php", $('#main').serialize(), function (ho) {
...
//alert(ho)
            ...
            //  $("#mes").html(ho);
            if ($.trim(ho) == "Y") {
                show_modal("Supplier for " + $('#company_name :selected').text() + "  Created");
                $("#main").bootstrapValidator('resetForm', true);
                $("#main")[0].reset();
            }
            else if ($.trim(ho) == "A") {
                show_modal("Supplier Already Exist for " + $('#company_name :selected').text() + "..");
            }

            else if ($.trim(ho) == "N") {
                show_modal("Failed to Create Supplier for " + $('#company_name :selected').text() + "..");
            }
            else if ($.trim(ho) !== "") {
                show_modal(ho);
            } 
...
function validate () {
  if(document.getElementById('client_country').value=="") {
    document.getElementById('client_country').value="Null";
  }
 if(document.getElementById('shipper_add2').value=="") {
    document.getElementById('shipper_add2').value="Null";
  }
  if(document.getElementById('shipper_pincode').value=="") {
    document.getElementById('shipper_pincode').value="0";
  }
  if(document.getElementById('shipper_city').value=="") {
    document.getElementById('shipper_city').value="Null";
  }
    if(document.getElementById('shipper_state').value=="") {
    document.getElementById('shipper_state').value="Null";
  }
    if(document.getElementById('client_gstin').value=="") {
    document.getElementById('client_gstin').value="Null";
  }
    if(document.getElementById('shipper_cin').value=="") {
    document.getElementById('shipper_cin').value="Null";
  }
}
</script>

    <form role="form" id="main" onsubmit='return validate ()'>

    <div class="panel panel-green  margin-bottom-40">
        <div class="panel-heading">
            <h3 class="panel-title"><i class="fa fa-tasks"></i> Create Supplier</h3>
        </div>
...
<!---->
                        <!--    <input type="hidden" name="companyId" id="cmpid">-->
                            ...
                            <div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">Supplier  Code<span style="color:red;" >*</span>:</label>
									<input type="text"  title="Name Only Characters Are Allowd" required="" id="shipper_code" class="form-control"  placeholder="Name" name="shipper_code">
								</div>
							</div>
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">Supplier  Name<span style="color:red;" >*</span>:</label>
							...
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">	
								<div class="form-group">
									...
									<input type="text"  class="form-control"  required="" id="shipper_add1"   placeholder="Address" name="shipper_add1">
								</div>
							</div>
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">Address 2:</label>
									<input type="text"  class="form-control" id="shipper_add2" value="" placeholder="Address" name="shipper_add2">
								</div>
							</div>
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">	
								<div class="">
									<label for="exampleInputPassword1">PinCode:</label>
									<input type="number"  maxlength="6" title="Only Numbers Are Required Must be 6 Digits" value="" class="form-control" id="shipper_pincode" placeholder="Pincode" name="shipper_pincode">
								</div>
							</div>
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">City:</label>
									<input type="text"  class="form-control"  id="shipper_city" value="" placeholder="City" name="shipper_city">
								</div>
							</div>
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">	
								<div class="form-group">
									<label for="exampleInputPassword1">State:</label>
									<input type="text"  class="form-control"  id="shipper_state"  placeholder="State" name="shipper_state">
								</div>
							</div>
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									 <label for="exampleInputPassword1">Country:</label>
									<input type="text" class="form-control" id="client_country" value="" placeholder="Country" name="client_country">
								</div>
							</div>
							<!-- <div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">TIN</label>
									<input type="text"  pattern="[a-zA-Z 0-9]+"  class="form-control" required="" id="shipper_tin" placeholder="TIN" name="shipper_tin" title="Only Characters are required">
								</div>
							</div> -->
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">GSTIN:</label>
									<input type="text" style="text-transform: uppercase;" class="form-control" value="" id="client_gstin" placeholder="GSTIN" name="client_gstin">
								</div>
							</div>							
							<div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="">
									<label for="exampleInputPassword1">CIN:</label>
									<input type="text"  pattern="[a-zA-Z 0-9]+"  class="form-control" value="" id="shipper_cin" placeholder="CIN" name="shipper_cin" title="Only Characters are required">
								</div>
							</div>
							<!-- <div style="margin-left: -15px;height: 80px" class="col-lg-6">
								<div class="form-group">
									<label for="exampleInputPassword1">VAT<span style="color:red;" >*</span>:</label>
									<input type="text"  pattern="[a-zA-Z 0-9]+"  class="form-control" required="" id="shipper_vat" placeholder="VAT" name="shipper_vat" title="Only Characters are required">
								</div>
							</div>-->						
							<div style="margin-left: -15px;height: 80px" class="col-lg-12">
								<center>
									<br><input type="submit" value="Save" class="btn btn-default" style="color:#ffffff;background-color: #2bb75b;width: 130px;" id="mainss">
								<br></center>
							</div>
    ...
    <div class="modal fade" id="myModal" data-backdrop="static" >
        <div class="modal-dialog">
            ...
            <div class="modal-content"> <form id="add_mores"   role="form">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h4 class="modal-title"> Supplier Details Add More</h4>
                    </div>
                    <div class="modal-body">
    ...
    $(function() {
        ...
        $("#challan_no").focus();
            ...
            fields: {
                ...
                shipper_code: {
                    message: 'The shipper code  is not valid',
                    validators: {
                        notEmpty: {
                            message: 'The shipper code  is required and cannot be empty'
                        },
                        stringLength: {
                            min: 2,
                            max: 40,
                            message: 'The shipper code  be more than 1 and less than 40 characters long'
                        },
                        regexp: {
                            regexp: /^[a-z 0-9-. ]+$/i,
                            message: 'Shipper Code cannot be special character'
                        }
               ...
               /*shipper_pincode: {
                    ...
                    validators: {
                        ...
                        regexp: {
                            regexp: /^[0-9]{6}$/,
                            message: 'The Pincode is incorrect should be atleast 6 characters'
                        }
