    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function set_sale_office(arr)
            {
                ...
                //var sales_off = "";
                var out = new Array();
				var sales_off="<option value=''>Select Sales Office</option>";
                for (var i = 0; i < obj.LIST.length; i++) {
...
//                        alert(warehouseOptions);
            ...
            {
                var sales_off=$("#typeids").val();
                query1 = {"sales_off": sales_off};
                $.get("getUpdateRoleForSalesOffice.php",query1,function(datas)
                {
                   // get_roles=obj;
                ...
                $.post("getUiTabsForProject_client_new.php","",function(datas1)
                {
                    $("#ui_table").html("");
											...
											<form role="form" class="">
												<div class="col-lg-6"> 												
														<div class="form-group">
															...
															<select onchange="get_sale_office()" id="typeid" class="form-control"></select>
														</div>
												</div>
												<div class="col-lg-6"> 
													<div class="form-group">
														<label for="exampleInputPassword1">Sales Office:</label>
														<select id='typeids' onchange="get_ui_tabs()" class='form-control'>
															<option>Select Sales Office</option>
														</select>
													</div>
												</div>
											</form>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#main").submit(function(e)
            {
                ...
                var sales_off=$("#typeids").val();
                //query1 = {"sales_off": sales_off};
                var query={"main_role_id":$("#company_name").val(),"role_id":roles_id,"postions":postions,"sales_off": sales_off};
                $.post("updateRole_company.php",query,function(returns)
                {
                    if($.trim(returns)=="Y")
                    {
                        ...
                        $("#main")[0].reset();
                        show_modal("Sales Office Role Updated Successfully");
                       // get_user_list();
                        setTimeout(function()
                        {
