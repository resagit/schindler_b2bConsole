...
$order_id1=get_form_name_value('order_id1_rto');
$warehouse_id=get_form_name_value('warehouseid1_rto');
$challan_no=get_form_name_value('challan_no1_rto');
$dates=get_form_name_value('datess1_rto');
$amount=get_form_name_value('amount');
$companyId=get_form_name_value('cmp_id1_rto');
...
$url="http://".$ip."/updateShipmentCost/$order_id1/$challan_no/$companyId/$warehouse_id/$amount/reverseShipment/$userNumber/$user_type";
$ch = curl_init();
