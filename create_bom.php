...
//$("#client_materialid").val( datass[i][3]);
                        ...
                        $("#client_materialid").val(material_id);
    ...
    function add_table()
    {
       ...
       // var uomss="";
        ...
        for (var i = 0; i < obj1.LIST.length; i++) {
           ...
           // uomss=   datass1[i][2];
if($("#autocomplete").val()== datass1[i][0].toUpperCase()){
    //alert(datass1[i][3])
  var m_client_id=datass1[i][3];
  //alert(m_client_id+"client_id");
}
        }
...
<input type="hidden" id="company_names">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="price" required="" title="Price" placeholder="Price" name="price" value="" disabled>
            </div>
...
//alert(clid+"materialid");
//alert(uom1+"uom");
                   // alert($("#code").val()+"code");
                   // alert($("#description").val()+"decr");
                    //alert(rate1+"prices");

                    //console.log(main_query);
                    //$("#myModal12").fadeIn();

    $.post("create_bom_data.php", main_query, function (cv) {
...
if(cv=="Y")
{
    show_modal("Bom Created Successfully");
    setTimeout(function(){
...
{
    show_modal("Failed To Create Bom");
}
