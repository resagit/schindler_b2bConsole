    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            function search_cmp()
            {
                ...
                $.get("getAllTaxForClient.php",query,function (ho){
...
//
                    ...
                    for (var i = 0; i < obj.tax.length; i++) {
                        ...
                        $("#tax tbody").append("<tr  onclick=''><td>" + data[i][0] + "</td><td>" + data[i][1] + "</td><td>" + data[i][2] + "</td><td>" + data[i][3] + "</td><td>" + data[i][4] + "</td><td>" + data[i][5] + "</td></tr>")
                    }
                    ...
                    <form role="form" id="main">
                        ...
                        <div class="col-lg-12 ">
                            <ul class="nav nav-tabs center-block navbar-btn">
                                <li class="active" id="ins"><a href="#tab1" data-toggle="tab">Tax</a></li>
                            ...
                            <div class="tab-content"><br><br>
                                <div class="tab-pane active col-lg-12" id="tab1">
                                    <div class="panel-group" id="accordion">
                                        ...
                                        <table id="tax" class='table table-striped'>
                                            <thead>
