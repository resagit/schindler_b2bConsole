...
if(isset($_SESSION['user_names']))
{
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            //assign[i] = new Array();
             function get_masterTax_data(){

                 $("#print_ui").html("");
                 $.get("getTaxValueMaster.php","",function(hh){
                     ...
                     for (var i = 0; i < obj.tax.length; i++) {
                         ...
                         datas1[i] = new Array();
                         datas1[i][0] = obj.tax[i].taxValueID;
                         datas1[i][1] = obj.tax[i].taxID;
                         datas1[i][2] = obj.tax[i].taxName;
                         datas1[i][3] = obj.tax[i].taxAmount;
                         datas1[i][4] = obj.tax[i].taxAmountUOM;
                         //assign[i] = new Array();
                         assign.push(datas1[i][1]);


                         $("#print_ui").append("<tr class='"+datas1[i][1]+"'><td>" + datas1[i][2] + "</td><td>" + datas1[i][3] + "</td><td>" + datas1[i][4] + "</td><td>  <input title='" + datas1[i][1] + "' value='" + datas1[i][0] + "' class='toggle-one' Un-checked type='checkbox'> </td></tr>")
...
if($("#company_typeids").val()!=="" || $("#typeid").val()!==""){
    ...
    if ($(this).prop("checked") == true) {
        ...
        var query = {
            "emp_id": $(this).attr("title"),
            "companyId": $("#ids_value").val(),
            "warehouseid": $("#warehouse_id").val()
        };
        $.get("assignTaxtoClient.php", query, function (xy) {
            ...
            if ($.trim(xy) != "Y") {
                ...
                $(this).hide();
                show_modal("Successfully Assign");
        ...
        var query1 = {
            ...
            "company_Id": $("#ids_value").val(),
            "warehouse_id": $("#warehouse_id").val()
        };

        $.get("unassignTaxtoClient.php", query1, function (xy) {
            ...
            if ($.trim(xy) != "Y") {
                ...
                show_modal("Successfully Un-Assign");
...
//                 alert("aghdg")
//                 //$('.check_ass').attr('input[type='checkbox']').prop('checked',false);
//             }
            function checked_unassign(){
...
//
            ...
            function get_ui_tabs()
            {
                ...
                $.get("getAllTaxForClient.php",query,function(datas)
                {
                    ...
                    for (var i = 0; i < obj.tax.length; i++) {
                        ...
                        data[i] = new Array();
                        data[i][0]=obj.tax[i].taxID;
                        data[i][1]=obj.tax[i].startDate;
                        data[i][2]=obj.tax[i].taxAmount;
                        data[i][3]=obj.tax[i].taxAmountUOM;
                        data[i][4]=obj.tax[i].taxName;
                        data[i][5]=obj.tax[i].taxDescription;
                        //alert(assign[i]);
                        if($.inArray(data[i][0],assign) > -1){
                            $("#print_ui ."+data[i][0]+"").hide();

                            $("#print_ui").append("<tr  onclick=''><td>" + data[i][4] + "</td><td>" + data[i][2] + "</td><td>" + data[i][3] + "</td><td>  <input title='" +data[i][0]+ "' value='" + data[i][0] + "' id='chk_assign' class='toggle-ones' checked type='checkbox' > </td></tr>");
                    ...
                    $('.toggle-ones').change(function()
                    {
                        ...
                        if($(this).prop("checked")==true)
                        {
                            ...
                            var query={"emp_id":$(this).attr("title"),"companyId":$("#ids_value").val(),"warehouseid":$("#warehouse_id").val()};
                            $.get("assignTaxtoClient.php",query,function(xy)
                            {
                        ...
                        else
                        {
                            ...
                            var query1={"empid":$(this).attr("title"),"company_Id":$("#ids_value").val(),"warehouse_id":$("#warehouse_id").val()};
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                            Assign/Un-Assign Tax For Client
                ...
                <div class="row">
                    ...
                    <table class="table table-striped"><thead><tr><th>Tax Name</th><th>Tax Amount</th><th>Tax Amount UOM</th></tr></thead>
