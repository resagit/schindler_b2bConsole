...
*/
    ...
    function edit_client1(a)
    {
       // alert(a);
        dg={"id":a};
        $.get("getsalesOfficeDetails.php",dg,function(xs)
        {
           // alert(xs);
            //  setState1(xs);
    ...
    function edit_client_details(data)
    {
        ...
        for (var i = 0; i < obj.LIST.length; i++) {
			...
			details[i][23] = obj.LIST[i].mobileNumber;
            //data[i][1]=obj.LIST[i].name;
            //data[i][7]=obj.DETAIL[i].requestTimestamp;
            /*if(its==shippers[i][0]) {
             $("#Ship_TIN").val(shippers[i][2]);
    ...
    else
    {
        ...
        $("#pano_no").val(details[i][6])
			...
			$("#client_mobile").val(details[i][23]);
        }
    }
...
if($("#client_name").val()!="" && $("#company_name").val()!="") {
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6" style="height: 70px">
                                        <div class="form-group">
                                            ...
                                            <button id="edit_client" onclick="get_client_list();" class="btn btn-primary">Submit</button>
                                        </div>
                                        <!-- <div class="col-lg-6">
                                             <div class="form-group">
...
function validate () {
 ...
 if(document.getElementById('client_add2').value=="") {
    document.getElementById('client_add2').value="Null";
  }
  if(document.getElementById('client_pin').value=="") {
    document.getElementById('client_pin').value="0";
  }
  if(document.getElementById('client_city').value=="") {
    document.getElementById('client_city').value="Null";
  }
    ...
    if(document.getElementById('client_cin').value=="") {
    document.getElementById('client_cin').value="Null";
  }
}
</script>
	...
	<form id="Client_Details_form" onsubmit='return validate ()'  role="form">
    <div class="modal-header">
        ...
        <div class="panel-body">
			...
			<div style="margin-left: -15px;height: 80px" class="col-lg-6">
                <div>
                    ...
                    <input type="text"  class="form-control" id="client_gstin"  placeholder="CIN" name="client_gstin">
                </div>
            </div>
            <!-- <div style="margin-left: -15px;height: 80px" class="col-lg-6">
                <div class="form-group">
               ...
               client_email:{
                        validators: {
                            ...
                            stringLength: {
                                min: 2,
                                max: 100,
                                message: 'The Email ID be more than 2 and less than 100 characters'
                            },
                            regexp: {
                                regexp: '^[^@\\s]+@([^@\\s]+\\.)+[^@\\s]+$',
