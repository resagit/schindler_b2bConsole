...
//                        alert(warehouseOptions);
            ...
            function search_by_date()
            {
                ...
                var dft={"startdate":a+"-"+b+"-"+c,"company_id":$("#ids_value").val(),"warehouse_id":$("#warehouse_id").val()};

                $.get("getViewBillDetails.php",dft,function(ty)
                {
                    ...
                    var datakt=new Array();
                        ...
                        datakt[0] = objmm.orderHandlingCost;
                        datakt[1] = objmm.shippingCost;
                        datakt[2] = objmm.taxPrecent;
                        datakt[3] = objmm.storageCost;

                        datakt[4] = objmm.totalTaxCost;
                        datakt[5] = objmm.totalCost;
                        datakt[6] = objmm.reverseShippingCost;
                    ...
                    g=datakt[6];
                            ...
                            $("#tbd1").append("<tr><td class='orderHandlingCost'>" + 'Order Handling Cost' + "</td><td><input type='hidden' id='order_handling' value='"+datakt[0]+"'></td><td class='orderHandlingCost'>" + datakt[0] + "</td></tr>");





                            $("#tbd1").append("<tr><td class='shippingCost'>" + 'Shipping Cost' + "</td><td><input type='hidden' id='ship_cost' value='"+datakt[1]+"'></td><td class='shippingCost'>" + datakt[1] + "</td></tr>");



                            $("#tbd1").append("<tr><td class='taxPrecent'>" + 'Tax Percent' + "</td><td><input type='hidden' id='tax_per' value='"+datakt[2]+"'></td><td class='taxPrecent'>" + datakt[2] + "</td></tr>");



                            $("#tbd1").append("<tr><td class='storageCost'>" + 'Storage Cost' + "</td><td><input type='hidden' id='stor_cost' value='"+datakt[3]+"'></td><td class='storageCost'>" + datakt[3] + "</td></tr>");



                            $("#tbd1").append("<tr><td class='totalTaxCost'>" + 'Total Tax Cost' + "</td><td><input type='hidden' id='total_tax_cost' value='"+datakt[4]+"'></td><td class='totalTaxCost'>" + datakt[4] + "</td></tr>");



                            $("#tbd1").append("<tr><td class='totalCost'>" + 'Total Cost' + "</td><td><input type='hidden' id='total_cost' value='"+datakt[5]+"'></td><td class='totalCost'>" + datakt[5] + "</td></tr>");



                            $("#tbd1").append("<tr><td class='reverseShippingCost'>" + 'Reverse Shipping Cost' + "</td><td><input type='hidden' id='rev_ship_cost' value='"+datakt[6]+"'></td><td class='reverseShippingCost'>" + datakt[6] + "</td></tr>");
...
//
            ...
            function generate_bill()
            {
                ...
                var dft1={"startdate":aq+"-"+bq+"-"+cq,"company_id":$("#ids_value").val(),"warehouse_id":$("#warehouse_id").val(),"orderHandlingCost":$("#order_handling").val(),"shippingCost":$("#ship_cost").val(),"taxPrecent":$("#tax_per").val(),"storageCost":$("#stor_cost").val(),"totalTaxCost":$("#total_tax_cost").val(),"totalCost":$("#total_cost").val(),"reverseShippingCost":$("#rev_ship_cost").val(),"company_name":$("#main_company_id1 option:selected").text(),"warehouse_name":$("#warehouse_id option:selected").text()};

               $.get("getGenerateBillDetails.php",dft1,function(ty)
               {
    ...
    <div id="wrapper" >
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="panel panel-green  margin-bottom-40" >
                        ...
                        <div class="panel-body">
                            ...
                            </div><div class="col-lg-12"><div class="col-lg-10 text-center center-block"> <center><br><div class="col-lg-2"></div><select style="width: 400px;"  class="form-control " name="warehouse_id" required="" id="warehouse_id" ></select></center><br><br></div></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls input-append date form_date pull-right"
                                                ...
                                                <span> <label class="control-label">Date </label></span>
                                                <input required=""
                ...
                <div class="panel panel-green  margin-bottom-40" >
                    <div class="panel-heading" >
                        <h3 class="panel-title"><i class="fa fa-tasks"></i> Bill Generate</h3>
                    </div>
                    ...
                    <div class="panel-body" style="overflow-y: auto">
                        ...
                        <table id="tabl_expr" class="table table-striped">
                            ...
                            <thead>
                            <tr>
                                <th class="item_code">Bill Type</th>
                                <th></th>
                                <th class="material_name">Total Amount</th>
                    ...
                    <center><input type="submit" value="Generate" onclick="generate_bill()" class="btn btn-default" style="color:#ffffff;background-color: #2bb75b;width: 130px;" id="mains"></center><br>
                </div>
